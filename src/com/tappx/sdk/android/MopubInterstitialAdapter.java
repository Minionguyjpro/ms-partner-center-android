...
public class MopubInterstitialAdapter extends CustomEventInterstitial {
    ...
    private TappxInterstitial f884a;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f885a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f885a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f885a     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    private static final class a implements TappxInterstitialListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final CustomEventInterstitial.CustomEventInterstitialListener f886a;

        private a(CustomEventInterstitial.CustomEventInterstitialListener customEventInterstitialListener) {
            this.f886a = customEventInterstitialListener;
        }
        ...
        public void onInterstitialClicked(TappxInterstitial tappxInterstitial) {
            this.f886a.onInterstitialClicked();
        }

        public void onInterstitialDismissed(TappxInterstitial tappxInterstitial) {
            this.f886a.onInterstitialDismissed();
        }

        public void onInterstitialLoadFailed(TappxInterstitial tappxInterstitial, TappxAdError tappxAdError) {
            Log.v("Tappx", "MoPub adapter: Interstitial load failed " + tappxAdError);
            this.f886a.onInterstitialFailed(MopubInterstitialAdapter.b(tappxAdError));
        }

        public void onInterstitialLoaded(TappxInterstitial tappxInterstitial) {
            Log.v("Tappx", "MoPub adapter: Interstitial loaded");
            this.f886a.onInterstitialLoaded();
        }

        public void onInterstitialShown(TappxInterstitial tappxInterstitial) {
            this.f886a.onInterstitialShown();
        }
    }

    /* access modifiers changed from: private */
    public static MoPubErrorCode b(TappxAdError tappxAdError) {
        int i = AnonymousClass1.f885a[tappxAdError.ordinal()];
    ...
    public void loadInterstitial(Context context, CustomEventInterstitial.CustomEventInterstitialListener customEventInterstitialListener, Map<String, Object> map, Map<String, String> map2) {
        ...
        if (str == null || str.isEmpty()) {
            ...
            this.f884a = tappxInterstitial;
            tappxInterstitial.setListener(new a(customEventInterstitialListener, (AnonymousClass1) null));
            this.f884a.loadAd(new AdRequest().mediator(BuildConfig.SDK_NAME));
    ...
    public void onInvalidate() {
        TappxInterstitial tappxInterstitial = this.f884a;
        if (tappxInterstitial != null) {
            tappxInterstitial.destroy();
            this.f884a.setListener((TappxInterstitialListener) null);
            this.f884a = null;
        }
    }
