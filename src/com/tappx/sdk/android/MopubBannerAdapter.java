...
class MopubBannerAdapter extends CustomEventBanner {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f882a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f882a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f882a     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    private static final class a implements TappxBannerListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final CustomEventBanner.CustomEventBannerListener f883a;

        private a(CustomEventBanner.CustomEventBannerListener customEventBannerListener) {
            this.f883a = customEventBannerListener;
        }
        ...
        public void onBannerLoadFailed(TappxBanner tappxBanner, TappxAdError tappxAdError) {
            ...
            this.f883a.onBannerFailed(MopubBannerAdapter.b(tappxAdError));
        }

        public void onBannerLoaded(TappxBanner tappxBanner) {
            Log.v("Tappx", "MoPub adapter: Banner loaded");
            this.f883a.onBannerLoaded(tappxBanner);
        }
    }
    ...
    public static MoPubErrorCode b(TappxAdError tappxAdError) {
        int i = AnonymousClass1.f882a[tappxAdError.ordinal()];
    ...
    public void loadBanner(Context context, CustomEventBanner.CustomEventBannerListener customEventBannerListener, Map<String, Object> map, Map<String, String> map2) {
        ...
        this.f881a = tappxBanner;
        tappxBanner.setListener(new a(customEventBannerListener, (AnonymousClass1) null));
        this.f881a.setAdSize(a4);
        this.f881a.loadAd(new AdRequest().mediator(BuildConfig.SDK_NAME));
        Log.v("Tappx", "Loading " + getClass().getSimpleName());
    }

    /* access modifiers changed from: protected */
    public void onInvalidate() {
        TappxBanner tappxBanner = this.f881a;
        if (tappxBanner != null) {
