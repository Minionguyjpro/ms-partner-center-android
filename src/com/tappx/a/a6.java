...
public class a6 {
    ...
    public static String f610a = "Volley";
    public static boolean b = Log.isLoggable("Volley", 2);
    private static final String c = a6.class.getName();

    public static void a(Throwable th, String str, Object... objArr) {
        Log.e(f610a, a(str, objArr), th);
    }

    public static void b(String str, Object... objArr) {
        Log.d(f610a, a(str, objArr));
    }

    public static void c(String str, Object... objArr) {
        Log.e(f610a, a(str, objArr));
    }

    public static void d(String str, Object... objArr) {
        if (b) {
            Log.v(f610a, a(str, objArr));
        }
    }
    ...
    static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final List<C0029a> f611a = new ArrayList();
        ...
        private static class C0029a {
            ...
            public C0029a(String str, long j, long j2) {
                this.f612a = str;
                this.b = j;
                this.c = j2;
            }
        ...
        public synchronized void a(String str, long j) {
            if (!this.b) {
                this.f611a.add(new C0029a(str, j, SystemClock.elapsedRealtime()));
            } else {
        ...
        public synchronized void a(String str) {
            ...
            long a2 = a();
            if (a2 > 0) {
                long j = this.f611a.get(0).c;
                a6.b("(%-4d ms) %s", Long.valueOf(a2), str);
                for (C0029a next : this.f611a) {
                    long j2 = next.c;
                    a6.b("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(next.b), next.f612a);
                    j = j2;
                }
            }
        }
