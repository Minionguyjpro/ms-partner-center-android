...
public class c6 implements n5 {
    ...
    public com.tappx.a.q5 a(com.tappx.a.s5<?> r29) {
        ...
        L_0x0008:
            ...
            com.tappx.a.b6 r3 = r7.f639a     // Catch:{ SocketTimeoutException -> 0x0165, MalformedURLException -> 0x0149, IOException -> 0x00bd }
        ...
        L_0x0043:
            ...
            byte[] r0 = r0.f697a     // Catch:{ SocketTimeoutException -> 0x0165, MalformedURLException -> 0x0149, IOException -> 0x005d }
            r24 = 1
            long r3 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x0165, MalformedURLException -> 0x0149, IOException -> 0x005d }
            long r25 = r3 - r9
            r21 = r1
