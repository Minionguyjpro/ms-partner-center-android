...
public class j0 {
    ...
    private static final Logger f714a = Logger.getLogger("com.tappx");
    ...
    static {
        f714a.setLevel(Level.ALL);
        f714a.addHandler(b);
        LogManager.getLogManager().addLogger(f714a);
    }
    ...
    private static void a(Level level, String str, Object... objArr) {
        try {
            f714a.log(level, String.format(str, objArr));
        } catch (Exception unused) {
        }
    }
