...
final class q2 {
    ...
    public String f() {
        return this.f798a.getString("tappx_privacy_gdpr_consent", (String) null);
    }
    ...
    public String h() {
        return this.f798a.getString("tappx_mark_choice", (String) null);
    }

    public String i() {
        return this.f798a.getString("tappx_privacy_consent_html", (String) null);
    }
    ...
    public String k() {
        return this.f798a.getString("tappx_usprivacy_string", (String) null);
    }
