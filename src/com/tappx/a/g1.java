...
public final class g1 {
    ...
    public static class b {
        ...
        private Location c() {
            if (!d3.a(this.f684a, "android.permission.ACCESS_FINE_LOCATION")) {
                return null;
            }
            return a("gps");
        }
        ...
        private Location e() {
            if (!(d3.a(this.f684a, "android.permission.ACCESS_FINE_LOCATION") || d3.a(this.f684a, "android.permission.ACCESS_COARSE_LOCATION"))) {
                return null;
            }
            return a("network");
        }
        ...
        private Location a(String str) {
            try {
                return ((LocationManager) this.f684a.getSystemService("location")).getLastKnownLocation(str);
