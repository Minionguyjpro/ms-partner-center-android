...
public class x {
    ...
    public w1 a(c0 c0Var) {
        String str = c0Var.f625a.get(c);
        int a2 = a(c0Var.f625a.get(u));
        boolean equals = "1".equals(c0Var.f625a.get(r));
        String str2 = c0Var.f625a.get(v);
        if (w.equals(str)) {
            w1 w1Var = new w1();
    ...
    public j2 b(c0 c0Var) {
        String str = c0Var.f625a.get(s);
        if (URLUtil.isValidUrl(str)) {
            boolean equalsIgnoreCase = "1".equalsIgnoreCase(c0Var.f625a.get(r));
            String a2 = c0Var.a();
            if (a2 != null && a2.length() < 10) {
                a2 = null;
            }
            return new j2(equalsIgnoreCase, str, a2, c0Var.f625a.get(t));
        }
        throw new c2();
    }
    ...
    static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final String f856a = f.b("Z0s98+TEac+mapO900zQZA");
        ...
        public w1 b(c0 c0Var) {
            try {
                ...
                for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                    ...
                    u1 b = b(c0Var.f625a, jSONObject2, optInt);
                    if (b != null) {
