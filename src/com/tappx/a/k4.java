...
public class k4 {
    ...
    class a implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            k4.this.a(this.f733a, this.b, this.c);
        }
    }
    ...
    class b implements r3.b {
        ...
        public void a() {
            Toast.makeText(this.f734a, "Image downloaded", 0).show();
        }

        public void b() {
            Toast.makeText(this.f734a, "Image download failed", 0).show();
    ...
    public void a(Context context, URI uri) {
        this.f732a.a(context, uri.toString());
    }
