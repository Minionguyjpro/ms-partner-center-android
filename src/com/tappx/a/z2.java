...
public class z2 implements y2 {
    ...
    private void d(String str) {
        c("SavedReferrer = " + w2.a(this.f871a, "sp_tappx_referrer", "NotFound"));
    ...
    private void e(String str) {
        ...
        boolean z;
        if (this.c == c.NORMAL) {
            str2 = w2.a(this.f871a, "sp_tappx_referrer", "NotFound");
        } else {
            str2 = "NotFound";
        }
            ...
            if (a5 == null || a5.length() <= 0) {
                ...
                if (c.TESTINSTALL_APP.equals(this.c)) {
                    try {
                        ...
                        intent.putExtra("android.intent.extra.TEXT", a3 + "|" + c() + "|" + this.f871a.getApplicationContext().getPackageName());
    ...
    public void a(Intent intent) {
        ...
        if (this.c != c.GETCLASS) {
            ...
            if (c2 == null || c2.length() <= 0) {
                if ("NotFound".equals(w2.a(this.f871a, "sp_tappx_referrer", "NotFound"))) {
                    a("sp_tappx_referrer", c2);
                    if ("NotFound".equals(w2.a(this.f871a, "sp_tappx_referrer_send", "NotFound"))) {
                        a("sp_tappx_referrer_send", "0");
                    }
                ...
                c("SavedReferrer = " + w2.a(this.f871a, "sp_tappx_referrer", "NotFound"));
                c("InstallSend   = " + w2.a(this.f871a, "sp_tappx_referrer_send", "NotFound"));
                return;
            }
            try {
                d(c2);
    ...
    private void a(String str, String str2) {
        if (this.c == c.NORMAL) {
            w2.b(this.f871a, str, str2);
        }
    }

    /* access modifiers changed from: private */
    public void a(boolean z) {
        if (this.c == c.NORMAL && !"1".equals(w2.a(this.f871a, "sp_tappx_referrer_send", "NotFound"))) {
            String a2 = w2.a(this.f871a, "sp_tappx_install_id", "NotFound");
            if ("NotFound".equals(a2) || "".equals(a2)) {
                w2.b(this.f871a, "sp_tappx_referrer_send", "0");
                return;
            }
            if (!z) {
                j0.a("Trying to Track Install", new Object[0]);
            ...
            if (a(b2.getCharSequence("HTML"), "").trim().equals("1")) {
                w2.b(this.f871a, "sp_tappx_referrer_send", "1");
                j0.a("ti->ok", new Object[0]);
                j0.a("Install Tracked", new Object[0]);
                return;
            }
    ...
    private String b() {
        ...
        m1 b2 = this.b.b();
        try {
            str = Settings.Secure.getString(this.f871a.getContentResolver(), "android_id");
        ...
        try {
            if (b2.d != null) {
                str2 = b2.d;
                return ("2:" + c() + ":" + InternalAvidAdSessionContext.AVID_API_LEVEL + ":" + "Native" + ":" + b2.f753a.trim() + ":" + str.trim() + ":" + this.d.trim() + ":" + this.e.trim() + "::" + this.f.trim() + ":" + str2).trim();
            }
