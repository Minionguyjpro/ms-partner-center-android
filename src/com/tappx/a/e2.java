...
public class e2 {
    ...
    private final Rect f663a = new Rect();
    ...
    public a a(ViewGroup viewGroup) {
        int i;
        boolean localVisibleRect = viewGroup.getLocalVisibleRect(this.f663a);
        if (!localVisibleRect) {
            if (b(viewGroup)) {
            ...
            int a2 = a((View) viewGroup, this.f663a);
            i = viewGroup.getChildCount() > 0 ? Math.min(a2, a(viewGroup, this.f663a)) : a2;
        }
