    ...
    public static class b {
        ...
        static class a {
            ...
            private static final class C0033a {
                ...
                class C0034a implements Runnable {

                    /* renamed from: a  reason: collision with root package name */
                    final /* synthetic */ CountDownLatch f784a;

                    C0034a(CountDownLatch countDownLatch) {
                        this.f784a = countDownLatch;
                    }

                    public void run() {
                        C0033a aVar = C0033a.this;
                        String unused = aVar.f783a = aVar.b();
                ...
                public String a() {
                    ...
                    g3.a(new C0034a(countDownLatch));
                    try {
            ...
            private String d() {
                ...
                try {
                    return declaredConstructor.newInstance(new Object[]{this.f782a, null}).getUserAgentString();
                } finally {
                    if (!isAccessible) {
