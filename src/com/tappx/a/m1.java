...
public final class m1 {
    ...
    public static class a {
        ...
        private String c() {
            String string = Settings.Secure.getString(this.f754a.getContentResolver(), "android_id");
            if (string == null) {
                return null;
            }
            return e3.a(string);
        ...
        private String d() {
            try {
                return String.valueOf(this.f754a.getPackageManager().getPackageInfo("com.google.android.gms", 0).versionCode);
        ...
        private String e() {
            int identifier = this.f754a.getResources().getIdentifier("google_play_services_version", "string", this.f754a.getPackageName());
            if (identifier == 0) {
                return null;
            }
            return String.valueOf(this.f754a.getResources().getInteger(identifier));
        }
