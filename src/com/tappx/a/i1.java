...
public final class i1 {
    ...
    public static class a {
        ...
        public i1 a() {
            ...
            if (!d3.a(this.f704a, "android.permission.ACCESS_NETWORK_STATE") || (activeNetworkInfo = ((ConnectivityManager) this.f704a.getSystemService("connectivity")).getActiveNetworkInfo()) == null) {
                str2 = null;
                str = null;
            } else {
            ...
            TelephonyManager telephonyManager = (TelephonyManager) this.f704a.getSystemService("phone");
