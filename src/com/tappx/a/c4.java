...
public class c4 {
    ...
    class f implements k4.c {
        ...
        public void a(f4 f4Var) {
            c4.this.a(this.f637a, f4Var.getMessage());
        }
    }
    ...
    public void a(q4 q4Var) {
        ...
        if (Build.VERSION.SDK_INT >= 17 && (this.f631a == b4.INTERSTITIAL || o.b)) {
    ...
    public void a(h4 h4Var, Map<String, String> map) {
        if (h4Var.a(this.f631a) && !this.f) {
            throw new f4("Click required");
        } else if (this.c == null) {
            throw new f4("Invalid state");
        } else if (this.d != null) {
            switch (g.f638a[h4Var.ordinal()]) {
                case 1:
                    this.c.a();
                    return;
                case 2:
