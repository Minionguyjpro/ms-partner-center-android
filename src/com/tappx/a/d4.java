...
public class d4 {
    ...
    private final WeakReference<Activity> f646a;
    ...
    class g implements Runnable {
        ...
        public void run() {
            ...
            d4.this.h.a(iArr[0], iArr[1], this.f652a.getWidth(), this.f652a.getHeight());
    ...
    static class j {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Handler f654a = new Handler(Looper.getMainLooper());
        private a b;
        ...
        static class a {
            ...
            class C0031a implements Runnable {

                /* renamed from: com.tappx.a.d4$j$a$a$a  reason: collision with other inner class name */
                class C0032a implements ViewTreeObserver.OnPreDrawListener {
                    ...
                    public boolean onPreDraw() {
                        this.f657a.getViewTreeObserver().removeOnPreDrawListener(this);
                        a.this.b();
                        return true;
                    }
                }
        ...
        public a a(View... viewArr) {
            a aVar = new a(this.f654a, viewArr, (a) null);
            this.b = aVar;
            return aVar;
        }
    ...
    d4(Context context, b4 b4Var, c4 c4Var, c4 c4Var2, j jVar) {
        ...
        if (context instanceof Activity) {
            this.f646a = new WeakReference<>((Activity) context);
        } else {
            this.f646a = new WeakReference<>((Object) null);
        }
        this.c = b4Var;
        this.o = c4Var;
        this.p = c4Var2;
    ...
    public ViewGroup l() {
        ...
        View a2 = w4.a((Context) this.f646a.get(), this.d);
        return a2 instanceof ViewGroup ? (ViewGroup) a2 : this.d;
    }

    /* access modifiers changed from: private */
    public boolean m() {
        Activity activity = (Activity) this.f646a.get();
    ...
    class i extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            int h;
            if (this.f653a != null && "android.intent.action.CONFIGURATION_CHANGED".equals(intent.getAction()) && (h = d4.this.k()) != this.b) {
