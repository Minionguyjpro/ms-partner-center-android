...
public class a {
    ...
    private static final byte[] f567a = {10, 30, 84, 95, 101, 20, 0, 14, 15, 80, 36, 84, 64, 82, 84, 64, 80, 80, 65, 78, 84, 73, 70, 82, 65, 85, 68, 75, 69, 89, 1, 2, 3, 8, 15, 42, 10, 51, 44, 32};
    ...
    public static String b(String str) {
        ...
        byte[] a2 = a(str.getBytes(), (int) f567a[5]);
        String str2 = new String(f567a);
        byte[] bArr2 = f567a;
        try {
