...
public class g {
    ...
    protected com.startapp.android.publish.adsCommon.g f530a;
    ...
    class a implements AdEventListener {
        ...
        public void onReceiveAd(Ad ad) {
            ...
            boolean z = g.this.f530a != null && g.this.f530a.getVideoCancelCallBack();
            if (!this.b && !z) {
                this.b = true;
    ...
    public boolean g() {
        com.startapp.android.publish.adsCommon.g gVar = this.f530a;
    ...
    public com.startapp.android.publish.adsCommon.g j() {
        ...
        i.a(this.j, this.l);
        int i2 = AnonymousClass3.f533a[this.i.ordinal()];
        if (i2 == 1) {
            gVar = new d(this.j);
        } else if (i2 != 2) {
            if (i2 == 3) {
