...
public class a {
    ...
    final Map<c, g> f519a = new ConcurrentHashMap();
    protected boolean b = false;
    private Map<String, String> d = new WeakHashMap();
    private boolean e = false;
    private Queue<C0023a> f = new ConcurrentLinkedQueue();
    private g.b g;
    private Context h;
    ...
    private class C0023a {
        ...
        C0023a(StartAppAd startAppAd, AdPreferences.Placement placement, AdPreferences adPreferences, AdEventListener adEventListener) {
            this.f526a = startAppAd;
            this.b = placement;
    ...
    public com.startapp.android.publish.adsCommon.g b(c cVar) {
        g gVar = cVar != null ? this.f519a.get(cVar) : null;
        if (gVar != null) {
            return gVar.b();
        }
        return null;
    ...
    public synchronized List<g> d() {
        return new ArrayList(this.f519a.values());
    }
            ...
            com.startapp.common.g.a(g.a.DEFAULT, (Runnable) new Runnable() {
                public void run() {
                    try {
                        ...
                        e.a(context, i.c());
                        c cVar = null;
                        for (Map.Entry next : a.this.f519a.entrySet()) {
    ...
    public c a(Context context, StartAppAd startAppAd, AdPreferences.Placement placement, AdPreferences adPreferences, AdEventListener adEventListener, boolean z, int i) {
        ...
        this.f.add(new C0023a(startAppAd, placement, adPreferences2, adEventListener));
        return cVar;
    }

    public void a(AdPreferences.Placement placement) {
        synchronized (this.f519a) {
            Iterator<Map.Entry<c, g>> it = this.f519a.entrySet().iterator();
            while (it.hasNext()) {
    ...
    private void a(c cVar, g gVar, Context context) {
        synchronized (this.f519a) {
            ...
            if (maxCacheSize != 0 && c() >= maxCacheSize) {
                ...
                c cVar2 = null;
                for (c next : this.f519a.keySet()) {
                    g gVar2 = this.f519a.get(next);
                ...
                if (cVar2 != null) {
                    this.f519a.remove(cVar2);
                }
            }
            this.f519a.put(cVar, gVar);
    ...
    static /* synthetic */ class AnonymousClass6 {
        ...
        static {
            ...
            L_0x005a:
                int[] r1 = f525a     // Catch:{ NoSuchFieldError -> 0x0064 }
    ...
    public boolean b(AdPreferences.Placement placement) {
        int i = AnonymousClass6.f525a[placement.ordinal()];
        if (i != 1) {
            if (i != 2) {
                return true;
            }
            ...
            this.g = new g.b() {
                public void a(g gVar) {
                    synchronized (a.this.f519a) {
                        c cVar = null;
                        for (c next : a.this.f519a.keySet()) {
                            if (a.this.f519a.get(next) == gVar) {
                                cVar = next;
                            }
                        }
                        if (cVar != null) {
