...
public abstract class a extends d {
    ...
    public Object e() {
        ...
        if (a(a2)) {
            if (this.i.size() == 0) {
                this.i.add(this.f467a.getPackageName());
            }
            this.h.setPackageExclude(this.i);
            this.h.setCampaignExclude(this.g);
            if (this.k > 0) {
                this.h.setEngInclude(false);
                if (MetaData.getInstance().getSimpleTokenConfig().b(this.f467a)) {
                    l.b(this.f467a);
                }
            }
            try {
                return com.startapp.android.publish.adsCommon.k.a.a(this.f467a, AdsConstants.a(AdsConstants.AdApiType.HTML, f()), this.h, (Map<String, String>) null);
            } catch (e e) {
                if (!MetaData.getInstance().getInvalidNetworkCodesInfoEvents().contains(Integer.valueOf(e.a()))) {
                    f.a(this.f467a, com.startapp.android.publish.adsCommon.f.d.EXCEPTION, "BaseHtmlService.sendCommand - network failure", e.getMessage(), "");
                }
    ...
    public boolean a(Object obj) {
        ...
        try {
            ...
            if (b.a().E() ? c.a(this.f467a, a3, this.k, this.i, this.j).booleanValue() : false) {
                return g();
            }
    ...
    public void a(boolean z) {
        ...
        com.startapp.common.b.a(this.f467a).a(intent);
        if (!z || this.b == null) {
            g.a("BaseHtmlService", 6, "Html onPostExecute failed error=[" + this.f + "]");
        } else if (this.l) {
            i.a(this.f467a, ((com.startapp.android.publish.adsCommon.e) this.b).f(), (i.a) new i.a() {
                public void a() {
    ...
    public boolean g() {
        ...
        this.k++;
        new com.startapp.android.publish.adsCommon.b.b(this.f467a, this.j).a();
