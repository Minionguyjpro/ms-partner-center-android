...
public class d extends c {
    ...
    private class b extends com.startapp.android.publish.adsCommon.g.a.a {
        ...
        public void setOrientationProperties(Map<String, String> map) {
            ...
            if (d.this.m.f488a != parseBoolean || d.this.m.b != com.startapp.android.publish.adsCommon.g.c.a.a(str)) {
                d.this.m.f488a = parseBoolean;
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            if (d.this.i == com.startapp.android.publish.adsCommon.g.a.d.LOADING) {
                ...
                if (MetaData.getInstance().isOmsdkEnabled()) {
                    d.this.e = null;
                    if (d.this.e != null) {
                        if (!(d.this.f265a == null || (a2 = d.this.f265a.a()) == null)) {
                            d.this.e.b(a2);
                        }
                        d.this.e.a(webView);
                        d.this.e.a();
