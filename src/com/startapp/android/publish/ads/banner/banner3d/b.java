...
public class b extends RelativeLayout {
    ...
    private void a() {
        ...
        this.f287a.setLayoutParams(layoutParams2);
        this.f287a.setTextColor(com.startapp.android.publish.adsCommon.b.a().q().intValue());
        this.f287a.setGravity(c.a(8388611));
        this.f287a.setBackgroundColor(0);
        int i = AnonymousClass2.f289a[templateBySize.ordinal()];
        if (i == 1 || i == 2) {
            this.f287a.setTextSize(17.0f);
            this.f287a.setPadding(a3, 0, 0, a2);
            ...
            this.f287a.setTextSize(22.0f);
            this.f287a.setPadding(a3, 0, 0, a4);
        }
        this.f287a.setSingleLine(true);
        this.f287a.setEllipsize(TextUtils.TruncateAt.END);
        h.a(this.f287a, com.startapp.android.publish.adsCommon.b.a().r());
        ...
        int i2 = AnonymousClass2.f289a[templateBySize.ordinal()];
        if (i2 == 1 || i2 == 2 || i2 == 3) {
        ...
        int i3 = AnonymousClass2.f289a[templateBySize.ordinal()];
        if (i3 == 1 || i3 == 2 || i3 == 3) {
        ...
        addView(this.c);
        addView(this.f287a);
        int i4 = AnonymousClass2.f289a[templateBySize.ordinal()];
        if (i4 == 1 || i4 == 2 || i4 == 3) {
            addView(this.e);
        } else if (i4 == 4 || i4 == 5) {
            addView(this.e);
