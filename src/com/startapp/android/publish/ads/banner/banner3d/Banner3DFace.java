...
public class Banner3DFace implements Parcelable, a.C0025a {
    ...
    public void a(Context context, BannerOptions bannerOptions, ViewGroup viewGroup) {
        ...
        this.h.setButtonText(this.f286a.isCPE());
    ...
    public Banner3DFace(Parcel parcel) {
        this.f286a = (AdDetails) parcel.readParcelable(AdDetails.class.getClassLoader());
