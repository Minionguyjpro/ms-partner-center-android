...
public class d {
    ...
    public d(Context context) {
        ...
        this.f311a = new RelativeLayout(context2);
        this.f311a.setBackgroundDrawable(new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{com.startapp.android.publish.adsCommon.b.a().n(), com.startapp.android.publish.adsCommon.b.a().o()}));
        ...
        this.f311a.setPadding(a6, a2, a6, a2);
        this.f311a.setTag(this);
        ...
        this.f311a.addView(this.b);
        this.f311a.addView(this.c);
        this.f311a.addView(this.d);
        this.f311a.addView(this.f);
        this.f311a.addView(this.e);
    }
    ...
    public void a(MetaDataStyle metaDataStyle) {
        if (this.g != metaDataStyle) {
            ...
            this.f311a.setBackgroundDrawable(new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{metaDataStyle.getItemGradientTop().intValue(), metaDataStyle.getItemGradientBottom().intValue()}));
