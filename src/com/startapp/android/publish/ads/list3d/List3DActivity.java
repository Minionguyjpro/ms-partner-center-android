...
public class List3DActivity extends Activity implements g {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.f295a = getIntent().getStringExtra("listModelUuid");
            ...
            b bVar = new b(this, this.c, str, this.b, this.f295a);
            f.a().a(this.f295a).a(this, !booleanExtra);
            ...
            this.d.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                    ...
                    f.a().a(List3DActivity.this.f295a).a(List3DActivity.this.c.get(i2).c());
            ...
            b bVar2 = new b(this, b.C0019b.LARGE, AdPreferences.Placement.INAPP_OFFER_WALL, (com.startapp.android.publish.adsCommon.adinformation.c) getIntent().getSerializableExtra("adInfoOverride"));
            this.h = bVar2;
