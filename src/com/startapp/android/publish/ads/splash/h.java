...
public class h {
    ...
    private void h() {
        this.h.initSplashLogo(this.f331a);
        if (!k()) {
            this.d = this.h.initSplashHtml(this.f331a);
        }
    }
    ...
    private boolean i() {
        int i2 = this.f331a.getResources().getConfiguration().orientation;
        ...
        int i3 = AnonymousClass7.f340a[this.h.getOrientation().ordinal()];
        boolean z = true;
        boolean z2 = false;
        if (i3 != 1) {
            if (i3 == 2) {
                ...
                com.startapp.common.a.c.b(this.f331a);
            }
        ...
        com.startapp.common.a.c.a(this.f331a);
        z2 = z;
        g.a("Splash", 4, "Set Orientation: [" + this.h.getOrientation().toString() + "]");
        return z2;
    }
    ...
    static /* synthetic */ class AnonymousClass7 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f340a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public boolean c() {
        ...
        if (this.h.validate(this.f331a)) {
            View j2 = j();
            if (j2 == null) {
                return false;
            }
            this.f331a.setContentView(j2, new ViewGroup.LayoutParams(-1, -1));
            return true;
        }
    ...
    private View j() {
        if (k()) {
            return this.h.getLayout(this.f331a);
        }
        d dVar = this.d;
        if (dVar != null) {
            return dVar.c();
    ...
    public void d() {
        ...
        a aVar = new a(this.f331a.getApplicationContext());
        this.f = aVar;
