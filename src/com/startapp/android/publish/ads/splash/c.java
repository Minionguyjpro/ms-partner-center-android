...
public class c {
    ...
    public void a(final Runnable runnable, final com.startapp.android.publish.cache.c cVar) {
        ...
        AnonymousClass1 r0 = new d() {
            ...
            public void a() {
                ...
                c.this.f322a.runOnUiThread(this.d);
            }
    ...
    public void c(Runnable runnable, com.startapp.android.publish.cache.c cVar) {
        ...
        this.c = a.DO_NOT_DISPLAY;
        if (cVar != null) {
            com.startapp.android.publish.adsCommon.c.a((Context) this.f322a, com.startapp.android.publish.adsCommon.c.a(com.startapp.android.publish.cache.a.a().b(cVar)), (String) null, a2.c());
        }
        if (Constants.a().booleanValue()) {
            i.a().a(this.f322a, a2.b());
        }
        k();
    }
    ...
    public void g() {
        if (!this.f) {
            this.f = true;
            b.a((Context) this.f322a).a(new Intent("com.startapp.android.splashHidden"));
        }
        if (this.j != null) {
            try {
                Log.v("startapp", "unregistering receiver");
                b.a((Context) this.f322a).a(this.j);
    ...
    public void j() {
        b.a((Context) this.f322a).a(this.j, new IntentFilter("com.startapp.android.adInfoWasClickedBroadcastListener"));
    }
