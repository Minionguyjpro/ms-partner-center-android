...
public class b {
    ...
    private VideoTrackingLink[] f344a;
    ...
    public b(VideoTrackingLink[] videoTrackingLinkArr, VideoTrackingParams videoTrackingParams, String str, int i) {
        this.f344a = videoTrackingLinkArr;
    ...
    public a a() {
        ...
        for (VideoTrackingLink videoTrackingLink : this.f344a) {
    ...
    private boolean b() {
        return (this.f344a == null || this.b == null) ? false : true;
    }
