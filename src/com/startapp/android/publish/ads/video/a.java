...
public class a extends GetAdRequest {
    ...
    private GetAdRequest.VideoRequestType f342a;
    ...
    private void a(Context context) {
        if (getType() != null) {
            if (getType() == Ad.AdType.NON_VIDEO) {
                this.f342a = GetAdRequest.VideoRequestType.DISABLED;
            } else if (getType() == Ad.AdType.VIDEO_NO_VAST) {
                this.f342a = GetAdRequest.VideoRequestType.FORCED_NONVAST;
            } else if (isAdTypeVideo()) {
                this.f342a = GetAdRequest.VideoRequestType.FORCED;
            }
            ...
            this.f342a = GetAdRequest.VideoRequestType.ENABLED;
        }
    }
    ...
    public e getNameValueMap() {
        ...
        nameValueMap.a("video", (Object) this.f342a, false);
