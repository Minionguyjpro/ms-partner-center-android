...
public class f extends com.startapp.android.publish.ads.a.c {
    ...
    private void aa() {
        ...
        AnonymousClass14 r0 = new c.C0018c() {
            public void a(int i) {
    ...
    public void a(c.g gVar) {
        ...
        int i2 = AnonymousClass13.f377a[gVar.a().ordinal()];
        if (i2 == 1) {
    ...
    public void Z() {
        super.z();
        a(U().getVideoTrackingDetails().getImpressionUrls(), new VideoTrackingParams(n(), 0, this.m, this.B), 0, "impression");
