...
public class b extends a {
    ...
    public boolean a(Object obj) {
        ...
        try {
            ...
            com.startapp.android.publish.ads.video.c.a.a a2 = bVar.a(this.f467a, vASTJson.getVastTag(), this.k);
    ...
    public void a(final Boolean bool) {
        ...
        d.a().a(this.f467a.getApplicationContext(), b().getVideoUrl(), new g.a() {
    ...
    public boolean a(GetAdRequest getAdRequest) {
        ...
        if (!getAdRequest.isAdTypeVideo() || (a2 = h.a(this.f467a)) == h.a.ELIGIBLE) {
            return true;
        }
        this.f = a2.a();
        return false;
    ...
    private void b(boolean z) {
        ...
        if ((this.b.getType() != Ad.AdType.REWARDED_VIDEO && this.b.getType() != Ad.AdType.VIDEO) || z) {
            ...
            com.startapp.android.publish.cache.c a2 = com.startapp.android.publish.cache.a.a().a(this.f467a, (StartAppAd) null, this.e, adPreferences2, (AdEventListener) null);
            if (z) {
                this.j = a2;
            }
        }
    ...
    public void a(com.startapp.android.publish.ads.video.c.a.a r10) {
        ...
        L_0x0085:
            r2 = move-exception
            android.content.Context r4 = r9.f467a     // Catch:{ Exception -> 0x00bb }
        ...
        L_0x0093:
            ...
            android.content.Context r1 = r9.f467a     // Catch:{ Exception -> 0x00bb }
        ...
        L_0x00bb:
            r10 = move-exception
            android.content.Context r1 = r9.f467a
    ...
    private boolean a(String str, Throwable th, boolean z) {
        ...
        if (z) {
            f.a(this.f467a, com.startapp.android.publish.adsCommon.f.d.EXCEPTION, str, th != null ? th.getMessage() : "", "");
        }
