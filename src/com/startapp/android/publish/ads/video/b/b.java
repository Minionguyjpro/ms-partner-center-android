...
public class b extends a implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener {
    ...
    public void a(String str) {
        ...
        super.a(str);
        this.i.setVideoPath(this.f347a);
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (com.startapp.android.publish.adsCommon.c.d(this.f347a) && (mediaPlayer2 = this.h) != null) {
        ...
        } else if (!com.startapp.android.publish.adsCommon.c.d(this.f347a)) {
    ...
    private c.g a(int i2, int i3, int i4) {
        return new c.g(C0017b.a(i2) == C0017b.MEDIA_ERROR_SERVER_DIED ? c.h.SERVER_DIED : c.h.UNKNOWN, a.a(i3).toString(), i4);
    }
}
