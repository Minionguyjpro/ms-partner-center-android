...
public class NativeAdDetails implements NativeAdInterface {
    ...
    public NativeAdDetails(AdDetails adDetails, NativeAdPreferences nativeAdPreferences, int i, a aVar) {
        ...
        if (nativeAdPreferences.isAutoBitmapDownload()) {
            new com.startapp.common.a(getImageUrl(), new a.C0025a() {
                public void a(Bitmap bitmap, int i) {
                    NativeAdDetails.this.a(bitmap);
                    new com.startapp.common.a(NativeAdDetails.this.getSecondaryImageUrl(), new a.C0025a() {
                        public void a(Bitmap bitmap, int i) {
    ...
    public void a() {
        new Handler().post(new Runnable() {
            public void run() {
                g.a("StartAppNativeAd", 3, "SingleAd [" + NativeAdDetails.this.f315a + "] Loaded");
                if (NativeAdDetails.this.b != null) {
                    NativeAdDetails.this.b.onNativeAdDetailsLoaded(NativeAdDetails.this.f315a);
                }
            }
        });
    }
    ...
    static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f319a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public void sendClick(Context context) {
        if (this.c != null) {
            int i = AnonymousClass3.f319a[getCampaignAction().ordinal()];
            if (i == 1) {
    ...
    public void sendImpression(Context context) {
        if (!this.f) {
            this.f = true;
            if (this.c != null) {
                g.a("StartAppNativeAd", 3, "Sending Impression for [" + this.f315a + "]");
                c.a(context, this.c.getTrackingUrl(), new b(this.g));
                return;
            }
            return;
        }
        g.a("StartAppNativeAd", 3, "Already sent impression for [" + this.f315a + "]");
    }
}
