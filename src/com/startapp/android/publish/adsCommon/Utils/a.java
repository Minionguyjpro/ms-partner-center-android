...
public class a {
    ...
    public static final Map<String, Bitmap> f410a = new ConcurrentHashMap();
    ...
    private static android.graphics.Bitmap a(android.content.Context r3, java.lang.String r4, boolean r5) {
        /*
            java.util.Map<java.lang.String, android.graphics.Bitmap> r0 = f410a
        ...
        L_0x0047:
            ...
            java.util.Map<java.lang.String, android.graphics.Bitmap> r3 = f410a     // Catch:{ Exception -> 0x005e, all -> 0x0053 }
    ...
    public static void a(final Context context, final Bitmap bitmap, final String str, final String str2) {
        g.a(g.a.DEFAULT, (Runnable) new Runnable() {
            ...
            public void run() {
                /*
                    r5 = this;
                    java.util.Map r0 = com.startapp.android.publish.adsCommon.Utils.a.f410a
