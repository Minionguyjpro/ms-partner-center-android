...
public class f {
    ...
    public void a(Context context) {
        if (e() && f()) {
            if (this.f474a == null) {
                this.f474a = new StartAppAd(context);
            }
            this.f474a.loadAd(StartAppAd.AdMode.AUTOMATIC, new AdPreferences().setAi(true), new AdEventListener() {
                public void onReceiveAd(Ad ad) {
                    if (f.this.f474a.showAd()) {
