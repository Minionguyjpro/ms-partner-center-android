...
public abstract class BaseRequest implements NameValueSerializer {
    ...
    static class a {
        ...
        private ScanResult f405a;

        public a(ScanResult scanResult) {
            this.f405a = scanResult;
        }

        public String toString() {
            StringBuilder sb = new StringBuilder();
            ScanResult scanResult = this.f405a;
            if (scanResult != null) {
                sb.append(scanResult.SSID);
                sb.append(',');
                sb.append(this.f405a.BSSID);
                sb.append(',');
                sb.append(WifiManager.calculateSignalLevel(this.f405a.level, 5));
                sb.append(',');
                sb.append(this.f405a.level);
                sb.append(',');
                long a2 = c.a(this.f405a);
                if (a2 != 0) {
                    sb.append(a2);
                }
                sb.append(',');
                CharSequence b = c.b(this.f405a);
                if (b != null) {
                    sb.append(b);
                }
            }
