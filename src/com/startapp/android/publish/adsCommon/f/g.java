...
public class g {
    ...
    public boolean b() {
        ...
        try {
            i.a(this.f483a, this.b);
            try {
                l.b(this.f483a);
                this.c.fillLocationDetails(this.b, this.f483a);
                this.c.fillApplicationDetails(this.f483a, this.b);
            ...
            try {
                ...
                com.startapp.android.publish.adsCommon.k.a.a(this.f483a, a2, this.c, (Map<String, String>) null, MetaData.getInstance().getAnalyticsConfig().d(), MetaData.getInstance().getAnalyticsConfig().e());
                return true;
            } catch (e e) {
