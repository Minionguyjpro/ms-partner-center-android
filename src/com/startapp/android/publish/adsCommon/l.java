...
public class l {
    ...
    private static List<PackageInfo> f505a = null;
    ...
    public static void a(Context context, boolean z) {
        ...
        if ((d == null || e == null) && z) {
            try {
                g(context);
                d = new Pair<>(a.T1, com.startapp.common.f.a(a(f505a)));
    ...
    private static synchronized void g(Context context) {
        synchronized (l.class) {
            ...
            f505a = new CopyOnWriteArrayList();
            ...
            try {
                ...
                for (PackageInfo next : a2) {
                    ...
                    if (!c.a(next)) {
                        ...
                        f505a.add(next);
                    } else if (next.packageName.equals(Constants.f563a)) {
                        packageInfo = next;
                    }
                }
                f505a = b(f505a);
