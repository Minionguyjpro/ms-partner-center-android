...
public class o {
    ...
    private final Rect f517a = new Rect();

    public boolean a(View view, int i) {
        if (view == null || !view.hasWindowFocus() || !view.isShown() || a(view) || view.getRootView() == null || view.getRootView().getParent() == null || !view.getGlobalVisibleRect(this.f517a)) {
            return false;
        }
        ...
        long height = ((long) this.f517a.height()) * ((long) this.f517a.width());
