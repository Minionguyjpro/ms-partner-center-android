...
public class a implements Thread.UncaughtExceptionHandler {
    ...
    private final Thread.UncaughtExceptionHandler f471a = Thread.getDefaultUncaughtExceptionHandler();

    /* renamed from: com.startapp.android.publish.adsCommon.e.a$a  reason: collision with other inner class name */
    /* compiled from: StartAppSDK */
    public static final class C0020a implements com.startapp.common.b.a.a {
        public b create(int i) {
            if (i != 868418937) {
                return null;
            }
            return new b() {
                public void a(Context context, int i, Map<String, String> map, final b.C0027b bVar) {
    ...
    private a(Context context) {
        ...
        com.startapp.common.b.a.a((com.startapp.common.b.a.a) new C0020a());
    }
    ...
    public void uncaughtException(Thread thread, Throwable th) {
        ...
        this.f471a.uncaughtException(thread, th);
    }
}
