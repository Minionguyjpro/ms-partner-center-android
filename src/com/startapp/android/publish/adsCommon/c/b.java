...
public class b {
    ...
    public void a(boolean z) {
        ...
        this.c.a(c());
        if (!z || !c.a(this.f465a, "android.permission.BLUETOOTH_ADMIN")) {
            this.b.a(b());
            return;
        }
        ...
        this.e = e2;
        try {
            this.f465a.registerReceiver(e2, intentFilter);
    ...
    public void a() {
        ...
        if (c.a(this.f465a, "android.permission.BLUETOOTH_ADMIN") && this.e != null && (bluetoothAdapter = this.d) != null) {
            bluetoothAdapter.cancelDiscovery();
            try {
                this.f465a.unregisterReceiver(this.e);
            } catch (Exception e2) {
    ...
    private Set<BluetoothDevice> c() {
        ...
        try {
            if (c.a(this.f465a, "android.permission.BLUETOOTH") && this.d.isEnabled()) {
    ...
    private BluetoothAdapter d() {
        if (c.a(this.f465a, "android.permission.BLUETOOTH")) {
