...
public class b {
    ...
    public boolean a() {
        boolean z = this.b.contains("calendar") && Build.VERSION.SDK_INT >= 14 && c.a(this.f487a, "android.permission.WRITE_CALENDAR");
    ...
    public boolean c() {
        boolean z = this.b.contains("sms") && c.a(this.f487a, "android.permission.SEND_SMS");
    ...
    public boolean e() {
        boolean z = this.b.contains("tel") && c.a(this.f487a, "android.permission.CALL_PHONE");
