    ...
    public boolean c(String str) {
        ...
        try {
            ...
            if (Arrays.asList(strArr).contains(str2)) {
                b.class.getDeclaredMethod(str2, new Class[0]).invoke(this.f486a, new Object[0]);
                ...
                declaredMethod.invoke(this.f486a, new Object[]{a2.get(str3)});
            } else if (Arrays.asList(strArr3).contains(str2)) {
                b.class.getDeclaredMethod(str2, new Class[]{Map.class}).invoke(this.f486a, new Object[]{a2});
            }
