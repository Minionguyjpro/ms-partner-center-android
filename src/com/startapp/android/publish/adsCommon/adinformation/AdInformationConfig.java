...
public class AdInformationConfig implements Serializable {
    ...
    private transient EnumMap<ImageResourceType, e> f438a = new EnumMap<>(ImageResourceType.class);
    ...
    public String c() {
        return (!this.f438a.containsKey(ImageResourceType.INFO_L) || this.f438a.get(ImageResourceType.INFO_L).d().equals("")) ? "https://info.startappservice.com/InApp/resources/info_l.png" : this.f438a.get(ImageResourceType.INFO_L).d();
    }
    ...
    public void k() {
        this.f438a = new EnumMap<>(ImageResourceType.class);
    }
}
