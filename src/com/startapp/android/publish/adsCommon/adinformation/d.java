...
public class d extends RelativeLayout {
    ...
    public d(Context context, b.C0019b bVar, AdPreferences.Placement placement, c cVar, final View.OnClickListener onClickListener) {
        super(context);
        this.f = placement;
    ...
    public void a(b.C0019b bVar, c cVar) {
        ...
        this.f450a.setId(AdsConstants.AD_INFORMATION_ID);
        this.f450a.setImageBitmap(this.e.a(getContext()));
        ...
        this.f450a.setPadding(0, 0, 0, 0);
        this.g.addRules(layoutParams2);
        this.b.addView(this.f450a, layoutParams2);
