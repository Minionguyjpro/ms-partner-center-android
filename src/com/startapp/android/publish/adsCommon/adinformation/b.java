...
public class b implements View.OnClickListener {
    ...
    private Runnable n = new Runnable() {
        public void run() {
            try {
                b.this.d();
                b.this.e.a(b.this.f441a, true);
                b.this.d.a(b.this.f441a, true);
                b.this.a(false);
            } catch (Exception e) {
                f.a(b.this.f441a, new e(d.EXCEPTION, "AdInformationObject.acceptRunnable failed", e.getMessage()), "");
            }
        }
    };
    private Runnable o = new Runnable() {
        public void run() {
            try {
                b.this.d();
                l.b();
                b.this.e.a(b.this.f441a, false);
                b.this.d.a(b.this.f441a, true);
                b.this.a(false);
            } catch (Exception e) {
                f.a(b.this.f441a, new e(d.EXCEPTION, "AdInformationObject.declineRunnable failed", e.getMessage()), "");
            }
        }
    };
    private Runnable p = new Runnable() {
        public void run() {
            try {
                ...
                f.a(b.this.f441a, new e(d.EXCEPTION, "AdInformationObject.fullPrivacyPolicy failed", e.getMessage()), "");
            }
        }
    };
    ...
    public enum C0019b {
        ...
        private C0019b(AdInformationConfig.ImageResourceType imageResourceType, AdInformationConfig.ImageResourceType imageResourceType2) {
    ...
    public b(Context context, C0019b bVar, AdPreferences.Placement placement, c cVar) {
        this.f441a = context;
        this.i = placement;
        this.m = cVar;
        this.d = e();
    ...
    public void onClick(View view) {
        if (!this.e.b(this.f441a) || !(this.f441a instanceof Activity)) {
            c();
            return;
        }
        a(true);
        this.b = new RelativeLayout(this.f441a);
        try {
            WebView webView = new WebView(this.f441a);
            this.g = webView;
            ...
            this.g.addJavascriptInterface(new AdInformationJsInterface(this.f441a, this.n, this.o, this.p), "startappwall");
            Point point = new Point(1, 1);
            try {
                com.startapp.android.publish.adsCommon.Utils.h.a((WindowManager) this.f441a.getSystemService("window"), point);
                ...
                g();
                int i2 = AnonymousClass6.f447a[this.k.ordinal()];
                if (i2 == 1) {
                    b(this.b, point);
                } else if (i2 == 2) {
                    a(this.b, point);
                ...
                f.a(this.f441a, d.EXCEPTION, "AdInformationObject.onClick - system service failed", e2.getMessage(), "");
                a(false);
            }
        } catch (Exception e3) {
            f.a(this.f441a, d.EXCEPTION, "AdInformationObject.onClick - webview instantiation failed", e3.getMessage(), "");
            a(false);
        }
    }
    ...
    static /* synthetic */ class AnonymousClass6 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f447a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public void c() {
        if (!i.a(256) || !MetaData.getInstance().isInAppBrowser()) {
            c.c(this.f441a, this.d.b());
        } else {
            c.b(this.f441a, this.d.b(), "");
        }
    }
    ...
    private void g() {
        String a2 = c.a(this.f441a, (String) null);
        if (a2 != null) {
    ...
    private void a(ViewGroup viewGroup, Point point) {
        this.l = true;
        Dialog dialog = new Dialog(this.f441a);
        this.h = dialog;
