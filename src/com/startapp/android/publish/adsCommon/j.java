...
public class j extends BaseRequest {
    ...
    public e getNameValueMap() {
        ...
        if (bVar != null) {
            ...
            nameValueMap.a("referrer_click_timestamp_seconds", (Object) Long.valueOf(this.f499a.b()), true);
            nameValueMap.a("install_begin_timestamp_seconds", (Object) Long.valueOf(this.f499a.c()), true);
        }
