...
public abstract class d {
    ...
    public GetAdRequest b(GetAdRequest getAdRequest) {
        Pair<String, String> d2 = l.d(this.f467a);
        try {
            getAdRequest.fillAdPreferences(this.f467a, this.c, this.e, d2);
            if (!b.a().D()) {
                com.startapp.common.a.g.a(6, "forceExternal - check - request - metadata false disabletwoclicks");
                if (c.a(this.f467a, this.e)) {
                    getAdRequest.setDisableTwoClicks(true);
                }
            }
            try {
                getAdRequest.fillApplicationDetails(this.f467a, this.c, false);
            } catch (Exception e2) {
                f.a(this.f467a, com.startapp.android.publish.adsCommon.f.d.EXCEPTION, "BaseService.GetAdRequest - fillApplicationDetails failed", e2.getMessage(), "");
            }
            return getAdRequest;
