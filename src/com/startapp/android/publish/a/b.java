...
public class b extends LinearLayout {
    ...
    private static Map<String, String> f264a = new HashMap<String, String>() {
        {
    ...
    private void a(String str) {
        try {
            int a2 = h.a(getContext(), 2);
            int a3 = h.a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a4 = a.a(getContext(), str);
            if (a4 == null) {
                a4 = d.a(f264a.get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a4, h.a(getContext(), 15), h.a(getContext(), 15), true));
