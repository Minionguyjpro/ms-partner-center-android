...
public abstract class a extends d {
    ...
    public Object e() {
        ...
        a2.setEngInclude(z);
        try {
            return (GetAdResponse) com.startapp.android.publish.adsCommon.k.a.a(this.f467a, AdsConstants.a(AdsConstants.AdApiType.JSON, f()), a2, (Map<String, String>) null, GetAdResponse.class);
        } catch (e e) {
    ...
    public boolean a(Object obj) {
        ...
        if (obj == null) {
            ...
            h hVar = (h) this.b;
            List<AdDetails> a2 = c.a(this.f467a, getAdResponse.getAdsDetails(), this.g, this.h);
            hVar.a(a2);
