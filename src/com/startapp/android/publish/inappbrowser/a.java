...
public class a extends b implements View.OnClickListener {
    ...
    private void y() {
        ...
        z();
        this.f.setWebViewClient(new C0024a(b(), this.e, this.g, this));
    ...
    /* compiled from: StartAppSDK */
    private static class C0024a extends WebViewClient {
        ...
        public C0024a(Context context, b bVar, AnimatingProgressBar animatingProgressBar, a aVar) {
            this.f559a = context;
