...
public class b extends RelativeLayout {
    ...
    public void b() {
        ...
        this.f560a.addView(this.l, h.a(getContext(), new int[]{0, 0, 0, 0}, new int[0]));
        this.f560a.addView(this.m, h.a(getContext(), new int[]{0, 0, 0, 0}, new int[0], 3, 2102));
        e();
        ...
        addView(this.f560a, h.a(getContext(), new int[]{16, 6, 16, 0}, new int[]{9}, 0, 2104));
    }
    ...
    private void f() {
        ...
        removeView(this.f560a);
        this.f560a.removeView(this.m);
        this.f560a.removeView(this.l);
        this.f560a.addView(this.l, h.a(getContext(), new int[]{0, 0, 0, 0}, new int[]{14}));
        this.f560a.addView(this.m, h.a(getContext(), new int[]{0, 0, 0, 0}, new int[]{14}, 3, 2102));
        RelativeLayout.LayoutParams a2 = h.a(getContext(), new int[]{16, 0, 16, 0}, new int[]{15}, 1, 2106);
        a2.addRule(0, 2104);
        addView(this.f560a, a2);
    }
