...
public class MetaData implements Serializable {
    ...
    public static final Set<String> DEFAULT_INSTALLERS_LIST = new HashSet(Arrays.asList(new String[]{Constants.f563a}));
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f544a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f544a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f544a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f544a     // Catch:{ NoSuchFieldError -> 0x003e }
    ...
    public String getAdPlatformHost(AdPreferences.Placement placement) {
        int i = AnonymousClass1.f544a[placement.ordinal()];
        if (i == 1) {
    ...
    /* compiled from: StartAppSDK */
    public static class a implements a.C0025a {
        ...
        public void a(Bitmap bitmap, int i) {
            if (bitmap != null) {
                com.startapp.android.publish.adsCommon.Utils.a.a(this.f545a, bitmap, this.b, ".png");
            }
        }
    }
}
