...
public class c {
    ...
    public Boolean c() {
        ...
        MetaDataRequest metaDataRequest = new MetaDataRequest(this.f550a, this.c);
        try {
            metaDataRequest.fillApplicationDetails(this.f550a, this.b, false);
            metaDataRequest.fillLocationDetails(this.b, this.f550a);
            com.startapp.common.a.g.a(3, "Networking MetaData");
            String a2 = com.startapp.android.publish.adsCommon.k.a.a(this.f550a, AdsConstants.a(AdsConstants.ServiceApiType.METADATA), metaDataRequest, (Map<String, String>) null).a();
            ...
            if (!(e2 instanceof UnknownHostException) || !e2.getMessage().contains("init.startappservice.com")) {
                com.startapp.android.publish.adsCommon.f.f.a(this.f550a, com.startapp.android.publish.adsCommon.f.d.EXCEPTION, "GetMetaDataAsync.doInBackground - MetaData request failed", e2.getMessage(), "");
            }
    ...
    private void d() {
        /*
            ...
            if (r1 == 0) goto L_0x00a2
            android.content.Context r1 = r3.f550a     // Catch:{ all -> 0x00a4 }
            if (r1 == 0) goto L_0x00a2
            boolean r1 = com.startapp.android.publish.adsCommon.Utils.i.a()     // Catch:{ all -> 0x00a4 }
            if (r1 != 0) goto L_0x0097
            android.content.Context r1 = r3.f550a     // Catch:{ Exception -> 0x001f }
        ...
        L_0x0039:
            android.content.Context r1 = r3.f550a     // Catch:{ Exception -> 0x0041 }
        ...
        L_0x004b:
            ...
            android.content.Context r1 = r3.f550a     // Catch:{ Exception -> 0x005b }
        ...
        L_0x0065:
            ...
            android.content.Context r1 = r3.f550a     // Catch:{ Exception -> 0x0075 }
        ...
        L_0x007f:
            ...
            if (r1 == 0) goto L_0x0097
            android.content.Context r1 = r3.f550a     // Catch:{ Exception -> 0x008d }
        ...
        L_0x008d:
            ...
            r3.a(r2, r1)     // Catch:{ all -> 0x00a4 }
        L_0x0097:
            android.content.Context r1 = r3.f550a     // Catch:{ Exception -> 0x00a2 }
    ...
    public void a(Boolean bool) {
        synchronized (MetaData.getLock()) {
            if (!this.j) {
                if (!bool.booleanValue() || this.d == null || this.f550a == null) {
                    MetaData.failedLoading();
                } else {
                    try {
                        MetaData.update(this.f550a, this.d);
                    } catch (Exception e2) {
    ...
    private void a(String str, String str2) {
        com.startapp.android.publish.adsCommon.f.f.a(this.f550a, new e(com.startapp.android.publish.adsCommon.f.d.EXCEPTION, str, str2), "");
    }
}
