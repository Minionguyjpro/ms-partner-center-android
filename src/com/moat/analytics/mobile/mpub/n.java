...
class n extends Exception {
    ...
    private static final Long f215a = 60000L;
    ...
    private static void b(java.lang.Exception r13) {
        /*
            ...
            com.moat.analytics.mobile.mpub.w$d r1 = r1.f225a     // Catch:{ Exception -> 0x01b0 }
        ...
        L_0x00eb:
            ...
            long r0 = r0 - r4
            java.lang.Long r2 = f215a     // Catch:{ Exception -> 0x01b0 }
            long r4 = r2.longValue()     // Catch:{ Exception -> 0x01b0 }
