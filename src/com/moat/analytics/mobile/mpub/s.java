        ...
        private b() {
            ...
            try {
                ...
                if (b2 != null) {
                    ...
                    this.f224a = telephonyManager.getSimOperatorName();
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (!((Boolean) cls2.getMethod(GpsHelper.IS_LIMIT_AD_TRACKING_ENABLED_KEY, new Class[0]).invoke(invoke, new Object[0])).booleanValue()) {
                            String unused = s.f221a = (String) cls2.getMethod("getId", new Class[0]).invoke(invoke, new Object[0]);
                            str2 = "Retrieved Advertising ID = " + s.f221a;
                        } else {
