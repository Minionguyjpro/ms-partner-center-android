...
class z {
    ...
    private static void a(b bVar, Rect rect, a aVar) {
        ...
        if (rect2.setIntersect(rect, rect2)) {
            ...
            if (w.a().c) {
                p.b(2, "VisibilityInfo", bVar.f238a, String.format(Locale.ROOT, "Covered by %s-%s alpha=%f", new Object[]{bVar.f238a.getClass().getName(), rect2.toString(), Float.valueOf(bVar.f238a.getAlpha())}));
            }
            aVar.b.add(rect2);
    ...
    private static void b(b bVar, Rect rect, a aVar) {
        if (h(bVar.f238a)) {
            boolean z = true;
            if (bVar.f238a instanceof ViewGroup) {
                int i = 0;
                boolean z2 = !ViewGroup.class.equals(bVar.f238a.getClass().getSuperclass()) || !j(bVar.f238a);
                ViewGroup viewGroup = (ViewGroup) bVar.f238a;
                int childCount = viewGroup.getChildCount();
                while (i < childCount) {
                    int i2 = aVar.f237a + 1;
                    aVar.f237a = i2;
    ...
    private static DisplayMetrics l(View view) {
        Activity activity;
        if (Build.VERSION.SDK_INT < 17 || a.f190a == null || (activity = (Activity) a.f190a.get()) == null) {
    ...
    public void a(java.lang.String r12, android.view.View r13) {
        ...
        L_0x0063:
            ...
            android.graphics.Rect r3 = r13.f239a     // Catch:{ Exception -> 0x013e }
            com.moat.analytics.mobile.mpub.z$c r4 = r11.b     // Catch:{ Exception -> 0x013e }
            android.graphics.Rect r4 = r4.f239a     // Catch:{ Exception -> 0x013e }
        ...
        L_0x0105:
            ...
            r11.f236a = r1     // Catch:{ Exception -> 0x013e }
            goto L_0x0144
        L_0x013e:
            r12 = move-exception
