...
class w {
                ...
                public void run() {
                    ...
                    handler.postDelayed(new a("MPUB", handler, new e() {
                        public void a(m mVar) {
                            synchronized (w.i) {
                                boolean z = ((k) MoatAnalytics.getInstance()).f212a;
                                if (w.this.f225a != mVar.e() || (w.this.f225a == d.OFF && z)) {
                                    w.this.f225a = mVar.e();
                                    if (w.this.f225a == d.OFF && z) {
                                        w.this.f225a = d.ON;
                                    }
                                    if (w.this.f225a == d.ON && !i.a().b()) {
                                        w.this.f225a = d.OFF;
                                    }
                                    if (w.this.f225a == d.ON) {
    ...
    public void d() {
        synchronized (i) {
            ...
            while (it.hasNext()) {
                if (currentTimeMillis - ((c) it.next()).f231a.longValue() >= 60000) {
                    it.remove();
                }
            }
            if (i.size() >= 15) {
