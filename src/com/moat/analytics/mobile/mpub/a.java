...
class a {
    ...
    static WeakReference<Activity> f190a;
    ...
    private static class C0015a implements Application.ActivityLifecycleCallbacks {
        C0015a() {
        }
        ...
        public void onActivityDestroyed(Activity activity) {
            try {
                ...
                if (a.b(activity)) {
                    a.f190a = new WeakReference<>((Object) null);
                }
            } catch (Exception e) {
                n.a(e);
            }
        ...
        public void onActivityResumed(Activity activity) {
            try {
                a.f190a = new WeakReference<>(activity);
                int unused = a.d = 3;
                w.a().b();
    ...
    public static boolean b(Activity activity) {
        WeakReference<Activity> weakReference = f190a;
