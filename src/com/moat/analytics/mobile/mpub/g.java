...
class g {
    ...
    g(Context context, a aVar) {
        ...
        try {
            this.b = new j(this.f196a, aVar == a.VIDEO ? j.a.NATIVE_VIDEO : j.a.NATIVE_DISPLAY);
        } catch (n e2) {
            n.a(e2);
        }
    }
    ...
    public void a(String str) {
        if (this.d == a.DISPLAY) {
            this.f196a.setWebViewClient(new WebViewClient() {
            ...
            this.f196a.loadData(b(str), "text/html", "utf-8");
        }
    }
        ...
        if (this.d == a.VIDEO) {
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                AnonymousClass2 r0 = new Runnable() {
                    public void run() {
                        try {
                            if (g.this.f196a != null && Build.VERSION.SDK_INT >= 19) {
                                WebView webView = g.this.f196a;
            ...
            this.f196a.loadData(a(this.c, str, num, num2, new JSONObject(map), num3), "text/html", "base64");
        }
    }
}
