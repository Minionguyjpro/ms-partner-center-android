...
import com.wPartnerCenter_14654626.R;
import java.io.File;
...
public class MainNavigationActivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
    ...
    public boolean onOptionsItemSelected(int i, MenuItem menuItem) {
        ...
        switch (i) {
            case R.id.webapp_about /*2131362366*/:
                AppsgeyserSDK.showAboutDialog(this);
                return true;
            case R.id.webapp_add_to_home /*2131362367*/:
                if (navigationWidget != null) {
                    navigationWidget.onAddToStartPageClick();
                }
                return true;
            case R.id.webapp_back /*2131362368*/:
                if (navigationWidget != null) {
                    navigationWidget.onClickBackButton();
                }
                return true;
            case R.id.webapp_downloads_list /*2131362369*/:
                startActivity(new Intent(this, DownloadsListActivity.class));
                return true;
            case R.id.webapp_exit /*2131362370*/:
                showCloseAppDialog();
                return true;
            case R.id.webapp_forward /*2131362371*/:
                if (navigationWidget != null) {
                    navigationWidget.onClickForwardButton();
                }
                return true;
            case R.id.webapp_home /*2131362372*/:
                if (navigationWidget != null) {
                    navigationWidget.onHomeButtonClick();
                }
                return true;
            case R.id.webapp_refresh /*2131362373*/:
            ...
            case R.id.webapp_share /*2131362376*/:
                ...
                return true;
            case R.id.webapp_theming /*2131362377*/:
