...
public class AppsgeyserServerClient {
    ...
    public void getConfigPhp(final Context context, DeviceIdParameters deviceIdParameters, ConfigPhpRequestListener configPhpRequestListener) {
        ...
        if (configPhp != null) {
            ...
            String str2 = getBaseConfigUrl(context) + "?widgetId=" + instance.getApplicationId() + "&guid=" + instance.getAppGuid() + "&v=" + "2.22.s" + "&market=" + getInstallerMarket(context) + str;
    ...
    private void sendRequestWithAllArgs(String str, int i, Context context) {
        ...
        if (!TextUtils.isEmpty(advId)) {
            str2 = context.getString(R.string.statDomainUrl) + "statistics.php?action=" + str + "&name=" + instance.getApplicationId() + "&id=" + instance.getAppGuid() + "&v=" + "2.22.s" + "&p=android&advid=" + advId + "&market=" + getInstallerMarket(context) + DeviceInfoGetter.getDeviceInfo(context) + "&templateversion=" + instance.getTemplateVersion();
        } else {
            str2 = context.getString(R.string.statDomainUrl) + "statistics.php?action=" + str + "&name=" + instance.getApplicationId() + "&id=" + instance.getAppGuid() + "&v=" + "2.22.s" + "&p=android&market=" + getInstallerMarket(context) + DeviceInfoGetter.getDeviceInfo(context) + "&templateversion=" + instance.getTemplateVersion();
        }
    ...
    private void sendRequestSdkStatisticsWithArgs(String str, int i, Context context) {
        Configuration instance = Configuration.getInstance(context);
        this.networkManager.sendRequestAsync(context.getString(R.string.statDomainUrl) + "sdk_statistics.php?action=" + str + "&wdid=" + instance.getApplicationId() + "&guid=" + instance.getAppGuid() + "&v=" + "2.22.s" + "&p=android" + DeviceInfoGetter.getDeviceInfo(context) + "&templateversion=" + instance.getTemplateVersion(), Integer.valueOf(i), context, this.networkManager.getEmptyRequestDoneListener(context), this.networkManager.getDefaultErrorListener(Integer.valueOf(i), context));
    }
