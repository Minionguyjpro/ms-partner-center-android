...
public final class i {
    ...
    public static final class a {
        ...
        public final String a(Context context) {
            ...
            new Handler(Looper.getMainLooper()).post(new C0036a(context, synchronousQueue));
        ...
        /* compiled from: StartAppSDK */
        static final class C0036a implements Runnable {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ Context f906a;
            final /* synthetic */ SynchronousQueue b;

            C0036a(Context context, SynchronousQueue synchronousQueue) {
                this.f906a = context;
