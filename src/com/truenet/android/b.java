...
public final class b {
    ...
    static final /* synthetic */ a.a.d.e[] f907a;
    ...
    static {
        Class<b> cls = b.class;
        f907a = new a.a.d.e[]{n.a((k) new l(n.a((Class) cls), "queue", "getQueue()Ljava/util/concurrent/SynchronousQueue;")), n.a((k) new l(n.a((Class) cls), "webView", "getWebView()Landroid/webkit/WebView;"))};
        a aVar = new a((e) null);
        b = aVar;
    ...
    public static final class C0037b {
        ...
        public static /* bridge */ /* synthetic */ C0037b a(C0037b bVar, String str, long j, int i, List<String> list, String str2, int i2, Object obj) {
            if ((i2 & 1) != 0) {
                str = bVar.f908a;
            }
            if ((i2 & 2) != 0) {
    ...
    private final C0037b a(String str, List<String> list) {
        ...
        this.f = null;
        if (b.a(str3)) {
            return new C0037b(str, 0, 200, (List<String>) null, (String) null);
        }
        ...
        try {
            ...
            if (openConnection != null) {
                ...
                httpURLConnection2.addRequestProperty("User-Agent", com.truenet.android.a.i.f905a.a(this.j));
                if (list != null) {
                ...
                C0037b bVar2 = new C0037b(str, currentTimeMillis2, httpURLConnection2.getResponseCode(), (List) httpURLConnection2.getHeaderFields().get("Set-Cookie"), str2);
                ...
                if (200 <= responseCode) {
                    if (299 >= responseCode) {
                        ...
                        if (z) {
                            return C0037b.a(bVar2, (String) null, currentTimeMillis3, 0, (List) null, (String) null, 29, (Object) null);
                        }
                        return C0037b.a(bVar2, (String) null, currentTimeMillis3, 0, (List) null, take, 13, (Object) null);
                    }
                }
                if (300 <= responseCode) {
                    if (399 >= responseCode) {
                ...
                return C0037b.a(bVar2, (String) null, 0, 0, (List) null, (String) null, 15, (Object) null);
            }
    ...
    static final class e implements Runnable {
        ...
        public final void run() {
            WebView b2 = this.b.k();
            if (b2 != null) {
                b2.loadDataWithBaseURL(this.e, this.b.f(), this.f911a.getContentType(), this.f911a.getContentEncoding(), (String) null);
            }
        }
    }
    ...
    public final void g() {
        ...
        L_0x0065:
            ...
            com.truenet.android.b$b r5 = (com.truenet.android.b.C0037b) r5
            long r5 = r5.b()
            long r3 = r3 + r5
            goto L_0x0065
        L_0x0077:
            ...
            com.truenet.android.b$b r2 = (com.truenet.android.b.C0037b) r2
