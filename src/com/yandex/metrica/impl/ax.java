...
class ax {
    ...
    static class a {
        ...
        public a a(Context context) {
            Context unused = this.f972a.f971a = context;
            return this;
        }

        /* access modifiers changed from: package-private */
        public a a(ay ayVar) {
            ay unused = this.f972a.b = ayVar;
            return this;
        }

        /* access modifiers changed from: package-private */
        public a a(j jVar) {
            j unused = this.f972a.c = jVar;
            return this;
        }

        /* access modifiers changed from: package-private */
        public a a(Handler handler) {
            Handler unused = this.f972a.d = handler;
            return this;
        }

        /* access modifiers changed from: package-private */
        public a a(dw dwVar) {
            dw unused = this.f972a.e = dwVar;
            return this;
        }
