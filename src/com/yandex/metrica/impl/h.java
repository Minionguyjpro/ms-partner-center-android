...
public class h {
    ...
    public Location e() {
        return this.f.f1005a;
    }

    /* access modifiers changed from: package-private */
    public h a(Location location) {
        this.f.f1005a = location;
        return this;
    }
    ...
    public Bundle a(Bundle bundle) {
        ...
        bundle2.putString("CounterReport.Event", this.f1004a);
        ...
        bundle2.putByteArray("CounterReport.GeoLocation", y.b(this.f.f1005a));
    ...
    public String toString() {
        return String.format(Locale.US, "[event: %s, type: %d, value: %s]", new Object[]{this.f1004a, Integer.valueOf(this.c), this.b});
    }
