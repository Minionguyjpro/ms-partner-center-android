...
class aj extends Thread {
    ...
    public void run() {
        ...
        L_0x0000:
            ...
            com.yandex.metrica.impl.ak r1 = r1.f957a     // Catch:{ InterruptedException -> 0x0032 }
            boolean r2 = r1.n()     // Catch:{ InterruptedException -> 0x0032 }
            if (r2 == 0) goto L_0x0024
            java.util.concurrent.Executor r2 = r5.f955a     // Catch:{ InterruptedException -> 0x0032 }
            goto L_0x0026
        L_0x0024:
