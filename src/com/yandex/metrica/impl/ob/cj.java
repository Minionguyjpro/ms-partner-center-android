...
public class cj {
    ...
    public cj(Context context) {
        this.f1063a = Build.MANUFACTURER;
        this.b = Build.MODEL;
    ...
    public cj(String str) throws JSONException {
        ...
        this.f1063a = jSONObject.getString("manufacturer");
    ...
    public JSONObject a() throws JSONException {
        ...
        jSONObject.put("manufacturer", this.f1063a);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (str == null ? cjVar.f1063a != null : !str.equals(cjVar.f1063a)) {
                return false;
            }
            String str2 = this.b;
    ...
    public String toString() {
        return "DeviceShapshot{mManufacturer='" + this.f1063a + '\'' + ", mModel='" + this.b + '\'' + ", mSerial='" + this.c + '\'' + ", mScreenSize=" + this.d + '}';
    }
}
