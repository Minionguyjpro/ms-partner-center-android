...
public class ca extends cb {
    ...
    private static final dk f1051a = new dk("SESSION_SLEEP_START");
    ...
    public a.C0046a a() {
        a.C0046a aVar;
        synchronized (this) {
            aVar = new a.C0046a(b(o.b(), "{}"), b(p.b(), 0));
        }
        return aVar;
    }

    public long i(long j2) {
        return b(f1051a.b(), j2);
    }
