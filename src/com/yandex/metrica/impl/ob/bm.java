...
public final class bm {
    ...
    public static final Boolean f1031a = false;
    ...
    interface v {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final String[] f1033a = {"key", "value", "type"};
    }

    public static final class w {

        /* renamed from: a  reason: collision with root package name */
        public static final String[] f1034a = {"name", "granted"};
    }
    ...
    public static final class y {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final String[] f1035a = {"id", "number", "name", "value", "type", com.appnext.base.b.d.fl, "session_id", "wifi_network_info", "cell_info", "location_info", "error_environment", "user_info", "session_type", "app_environment", "app_environment_revision", "truncated", "connection_type", "cellular_connection_type", "custom_type", "wifi_access_point"};
    ...
    public static final class z {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final String[] f1036a = {"id", "start_time", "network_info", "report_request_parameters", "server_time_offset", "type"};
    ...
    static {
        ...
        e = hashMap;
        hashMap.put("reports", y.f1035a);
        e.put("sessions", z.f1036a);
        e.put("preferences", x.f1033a);
    }
    ...
    public static bs b() {
        ...
        hashMap.put("preferences", x.f1033a);
        hashMap.put("startup", aa.f1033a);
        hashMap.put("permissions", w.f1034a);
