...
public class bn implements Closeable {
    ...
    private final ReentrantReadWriteLock f1037a;
    private final Lock b;
    private final Lock c = this.f1037a.writeLock();
    private final bo d;
    private final a e;
    ...
    public bn(u uVar, bo boVar) {
        ...
        this.f1037a = reentrantReadWriteLock;
    ...
    public void a(h hVar, bj bjVar, a.C0046a aVar) {
    ...
    public int a(SQLiteDatabase sQLiteDatabase) {
        try {
            Integer[] numArr = new Integer[p.f1183a.size()];
            Iterator it = p.f1183a.iterator();
            int i2 = 0;
            while (it.hasNext()) {
