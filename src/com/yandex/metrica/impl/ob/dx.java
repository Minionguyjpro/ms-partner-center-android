...
public class dx {
    ...
    private String f1104a = this.j.a((String) null);
    private String b;
    ...
    public synchronized void b(Map<String, String> map) {
        if (!bi.a(this.f1104a)) {
            map.put("yandex_mobile_metrica_uuid", this.f1104a);
        }
        if (!bi.a(this.b)) {
    ...
    private void e() {
        this.j.f(this.f1104a).g(this.b).h(this.c).i(this.d).d(this.g).j(this.h).m(this.i).o(this.e).h();
    }
    ...
    private synchronized boolean f() {
        return !bi.a(this.f1104a, this.b);
    }
