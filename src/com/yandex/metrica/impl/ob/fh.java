...
class fh {
    ...
    public static final String f1139a = fh.class.getSimpleName();
    private fb b;
    private fb c;
    private fs d;
    ...
    public synchronized boolean b() {
        if (j()) {
            Log.i(f1139a, "starting pins update on error");
            JSONObject g2 = g();
            if (g2 != null) {
                return a(g2);
            }
    ...
    public synchronized void c() {
        if (d() && j()) {
            Log.i(f1139a, "starting pins update on schedule");
            fi i2 = i();
            this.f = i2;
    ...
    public boolean a(JSONObject jSONObject) {
        try {
            ...
            Log.i(f1139a, "pins have been updated");
            return true;
