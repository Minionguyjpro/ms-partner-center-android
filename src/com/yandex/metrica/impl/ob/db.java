...
public class db {
    ...
    public static final Map<String, String> f1081a = Collections.unmodifiableMap(new HashMap<String, String>() {
        {
    ...
    /* access modifiers changed from: package-private */
    public String d() {
        return f1081a.get(this.b.j());
    }

    /* access modifiers changed from: package-private */
    public String e() {
        Map<String, ?> g = this.b.g();
        for (String f : f1081a.values()) {
            g.remove(dc.f(f));
        }
