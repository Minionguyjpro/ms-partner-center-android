...
public class t implements u {
    ...
    t(Context context, Executor executor, r rVar, CounterConfiguration counterConfiguration, q qVar, ba baVar) {
        ...
        if (J()) {
            ...
            if (p().b()) {
                p().a("Read app environment for component %s. Value: %s", l().toString(), this.p.b().f939a);
            }
        }
    ...
    public void b() {
        if ((this.n.a() >= ((long) this.k.c())) || this.f1175a) {
            f();
            this.f1175a = false;
        }
    }
    ...
    public void d() {
        this.d.postDelayed(this.x, ad.f940a);
    }
    ...
    public void h(h hVar) {
        this.p.a(hVar.j());
        a.C0046a b2 = this.p.b();
        if (this.q.a(b2, this.g) && p().b()) {
            p().a("Save new app environment for %s. Value: %s", l(), b2.f939a);
        }
    }
    ...
    public boolean z() {
        return ((((System.currentTimeMillis() / 1000) - this.r) > bh.f1026a ? 1 : (((System.currentTimeMillis() / 1000) - this.r) == bh.f1026a ? 0 : -1)) > 0) && h().M();
    }
