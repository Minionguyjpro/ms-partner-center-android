...
public class ch {
    ...
    public ch(JSONObject jSONObject, long j) throws JSONException {
        this.f1059a = jSONObject.getString("device_id");
    ...
    public String a() throws JSONException {
        ...
        jSONObject.put("device_id", this.f1059a);
        cj cjVar = this.b;
        if (cjVar != null) {
    ...
    public boolean a(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ch chVar = (ch) obj;
            if (this.d != chVar.d || !this.f1059a.equals(chVar.f1059a)) {
                return false;
            }
            cj cjVar = this.b;
            cj cjVar2 = chVar.b;
    ...
    public String toString() {
        return "Credentials{mFresh=" + this.d + ", mLastElectionsTime=" + this.c + ", mDeviceSnapshot=" + this.b + ", mDeviceID='" + this.f1059a + '\'' + '}';
    }
}
