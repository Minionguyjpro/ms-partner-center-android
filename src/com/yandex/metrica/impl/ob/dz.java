...
public final class dz {
    ...
    static abstract class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final Integer f1107a = Integer.MAX_VALUE;
    ...
    public String toString() {
        return "CellDescription{mSignalStrength=" + this.f1106a + ", mMobileCountryCode=" + this.b + ", mMobileNetworkCode=" + this.c + ", mLocationAreaCode=" + this.d + ", mCellId=" + this.e + ", mOperatorName='" + this.f + '\'' + ", mNetworkType='" + this.g + '\'' + ", mConnected=" + this.h + ", mCellType=" + this.i + ", mPci=" + this.j + '}';
    }
}
