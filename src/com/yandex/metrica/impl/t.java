...
public final class t {
    ...
    public t(String str) {
        try {
            this.f1187a = new JSONObject(str);
        } catch (Exception unused) {
            this.f1187a = new JSONObject();
        }
    }
    ...
    public t b() throws JSONException {
        ((JSONObject) a(this.f1187a, "dfid", new JSONObject())).put("boot_time", (System.currentTimeMillis() - SystemClock.elapsedRealtime()) / 1000);
        return this;
    }

    /* access modifiers changed from: package-private */
    public t a(Context context, boolean z) throws JSONException, UnsupportedEncodingException {
        JSONObject jSONObject = (JSONObject) a((JSONObject) a(this.f1187a, "dfid", new JSONObject()), "au", new JSONObject());
    ...
    public t a(Context context) throws JSONException {
        JSONObject jSONObject = (JSONObject) a((JSONObject) a(this.f1187a, "dfid", new JSONObject()), "apps", new JSONObject());
    ...
    public t c() throws JSONException {
        JSONObject jSONObject = (JSONObject) a(this.f1187a, "dfid", new JSONObject());
        long a2 = am.a(true);
        long a3 = am.a(false);
        long c = am.c(true);
        long c2 = am.c(false);
    ...
    public String d() {
        return Base64.encodeToString(new b().a(bi.c(this.f1187a.toString())), 0);
    }
}
