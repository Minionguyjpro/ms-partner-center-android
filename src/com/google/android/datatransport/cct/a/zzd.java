...
final class zzd extends zza {
    ...
    /* compiled from: com.google.android.datatransport:transport-backend-cct@@2.2.0 */
    static final class zza extends zza.C0011zza {
        private Integer zza;
        private String zzb;
        private String zzc;
        private String zzd;
        ...
        public zza.C0011zza zza(int i) {
            this.zza = Integer.valueOf(i);
            return this;
        }

        public zza.C0011zza zzb(String str) {
            this.zzh = str;
            return this;
        }

        public zza.C0011zza zzc(String str) {
            this.zzc = str;
            return this;
        }

        public zza.C0011zza zzd(String str) {
            this.zzg = str;
            return this;
        }

        public zza.C0011zza zze(String str) {
            this.zzb = str;
            return this;
        }

        public zza.C0011zza zzf(String str) {
            this.zzf = str;
            return this;
        }

        public zza.C0011zza zzg(String str) {
            this.zze = str;
            return this;
        }

        public zza.C0011zza zza(String str) {
            this.zzd = str;
            return this;
        }
        ...
        public zza zza() {
            ...
            if (str.isEmpty()) {
                return new zzd(this.zza.intValue(), this.zzb, this.zzc, this.zzd, this.zze, this.zzf, this.zzg, this.zzh, (zzc) null);
            }
