...
public final class DefaultAudioSink implements AudioSink {
    ...
    public static class DefaultAudioProcessorChain implements AudioProcessorChain {
        ...
        public DefaultAudioProcessorChain(AudioProcessor... audioProcessorArr) {
            ...
            audioProcessorArr3[audioProcessorArr.length + 1] = sonicAudioProcessor2;
        }
    ...
    public void configure(int i, int i2, int i3, int i4, int[] iArr, int i5, int i6) throws AudioSink.ConfigurationException {
        ...
        boolean z = isEncodingLinearPcm && i10 != 4;
        boolean z2 = this.enableConvertHighResIntPcmToFloat && supportsOutput(i11, 4) && Util.isEncodingHighResolutionIntegerPcm(i);
        ...
        if (channelConfig != 0) {
            Configuration configuration2 = new Configuration(isEncodingLinearPcm, isEncodingLinearPcm ? Util.getPcmFrameSize(i, i2) : -1, i3, isEncodingLinearPcm ? Util.getPcmFrameSize(i7, i9) : -1, i8, channelConfig, i7, i4, z, z && !z2, audioProcessorArr);
            if (isInitialized()) {
        ...
        if (this.inputBuffer == null) {
            ...
            if (this.startMediaTimeState == 0) {
                ...
                if (this.startMediaTimeState == 1 && Math.abs(inputFramesToDurationUs - j2) > 200000) {
                    Log.e("AudioTrack", "Discontinuity detected [expected " + inputFramesToDurationUs + ", got " + j2 + "]");
                    this.startMediaTimeState = 2;
                }
    ...
    public void setPlaybackParameters(PlaybackParameters playbackParameters2) {
        ...
        if (configuration2 != null && !configuration2.canApplyPlaybackParameters) {
            this.playbackParameters = PlaybackParameters.DEFAULT;
        } else if (playbackParameters2.equals(getPlaybackParameters())) {
        } else {
            if (isInitialized()) {
    ...
    private void applyPlaybackParameters(PlaybackParameters playbackParameters2, long j) {
        this.playbackParametersCheckpoints.add(new PlaybackParametersCheckpoint(this.configuration.canApplyPlaybackParameters ? this.audioProcessorChain.applyPlaybackParameters(playbackParameters2) : PlaybackParameters.DEFAULT, Math.max(0, j), this.configuration.framesToDurationUs(getWrittenFrames())));
