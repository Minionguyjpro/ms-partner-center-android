...
public final class ag {
    ...
    public ag(String str) {
        ...
        this.f153a = valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf);
    }

    private final int f(int i, String str, Object[] objArr) {
        if (Log.isLoggable("PlayCore", i)) {
            return Log.i("PlayCore", g(this.f153a, str, objArr));
        }
        return 0;
    }
    ...
    public final void c(Throwable th, String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 6)) {
            Log.e("PlayCore", g(this.f153a, str, objArr), th);
        }
    }
