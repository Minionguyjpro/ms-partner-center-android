...
public final class a extends b<InstallState> {
    ...
    public final void a(Context context, Intent intent) {
        ...
        if (!context.getPackageName().equals(intent2.getStringExtra("package.name"))) {
            this.f172a.a("ListenerRegistryBroadcastReceiver received broadcast for third party app: %s", intent2.getStringExtra("package.name"));
            return;
        }
        this.f172a.a("List of extras in received intent:", new Object[0]);
        for (String str : intent.getExtras().keySet()) {
            this.f172a.a("Key: %s; value: %s", str, intent.getExtras().get(str));
        }
        ag agVar = this.f172a;
        ...
        this.f172a.a("ListenerRegistryBroadcastReceiver.onReceive: %s", a2);
        i(a2);
    }
}
