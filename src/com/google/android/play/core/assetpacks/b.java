...
final class b extends w {
    ...
    private final ag f78a = new ag("AssetPackExtractionService");
    ...
    private final synchronized void d(Bundle bundle) {
        ...
        try {
            ...
            this.f78a.c(e, "Failed starting installation service.", new Object[0]);
            componentName = null;
        }
        if (componentName == null) {
            this.f78a.b("Failed starting installation service.", new Object[0]);
        }
    }

    public final void b(Bundle bundle, z zVar) throws RemoteException {
        this.f78a.a("updateServiceState AIDL call", new Object[0]);
    ...
    public final void c(z zVar) throws RemoteException {
        this.f78a.a("clearAssetPackStorage AIDL call", new Object[0]);
        if (!bp.a(this.b) || !bp.b(this.b)) {
            zVar.d(new Bundle());
            return;
        }
