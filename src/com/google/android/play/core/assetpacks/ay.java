...
final class ay extends AssetPackLocation {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof AssetPackLocation) {
            ...
            if (this.f76a == assetPackLocation.packStorageMethod() && ((str = this.b) != null ? str.equals(assetPackLocation.path()) : assetPackLocation.path() == null)) {
                String str2 = this.c;
    ...
    public final int hashCode() {
        int i = (this.f76a ^ 1000003) * 1000003;
        String str = this.b;
        int i2 = 0;
