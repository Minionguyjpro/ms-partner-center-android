...
final class cz {
    ...
    private static final ag f125a = new ag("SliceMetadataManager");
    ...
    public final boolean l() {
        ...
        try {
            ...
            f125a.b("Slice checkpoint file corrupt while checking if extraction finished.", new Object[0]);
            return false;
        } catch (IOException e2) {
            f125a.b("Could not read checkpoint while checking if extraction finished. %s", e2);
            return false;
        } catch (Throwable th) {
            bz.a(th, th);
        }
