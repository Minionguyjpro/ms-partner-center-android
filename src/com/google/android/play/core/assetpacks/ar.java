    ...
    public final void a(Context context, Intent intent) {
        ...
        if (bundleExtra != null) {
            ...
            if (stringArrayList == null || stringArrayList.size() != 1) {
                this.f172a.b("Corrupt bundle received from broadcast.", new Object[0]);
                return;
            }
            AssetPackState d2 = AssetPackState.d(bundleExtra, stringArrayList.get(0), this.g, at.b);
            this.f172a.a("ListenerRegistryBroadcastReceiver.onReceive: %s", d2);
        ...
        this.f172a.b("Empty bundle received from broadcast.", new Object[0]);
    }
