...
final class co {
    ...
    private static final ag f114a = new ag("MergeSliceTaskHandler");
    private final au b;
    ...
    public final void a(cn cnVar) {
        File i = this.b.i(cnVar.k, cnVar.f113a, cnVar.b, cnVar.c);
        if (i.exists()) {
            File j = this.b.j(cnVar.k, cnVar.f113a, cnVar.b);
            if (!j.exists()) {
                j.mkdirs();
            }
            b(i, j);
            try {
                this.b.l(cnVar.k, cnVar.f113a, cnVar.b, this.b.k(cnVar.k, cnVar.f113a, cnVar.b) + 1);
            } catch (IOException e) {
                f114a.b("Writing merge checkpoint failed with %s.", e.getMessage());
