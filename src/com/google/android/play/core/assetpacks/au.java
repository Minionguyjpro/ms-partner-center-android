...
final class au {
    ...
    private static final ag f73a = new ag("AssetPackStorage");
    ...
    private static long I(File file, boolean z) {
        ...
        if (z && file.listFiles().length > 1) {
            f73a.e("Multiple pack versions found, using highest version code.", new Object[0]);
        }
        try {
            for (File file2 : file.listFiles()) {
            ...
            f73a.c(e2, "Corrupt asset pack directories.", new Object[0]);
        }
    ...
    private final List<File> L() {
        ...
        try {
            ...
            f73a.b("Could not process directory while scanning installed packs. %s", e2);
        }
    }
    ...
    public final AssetPackLocation d(String str) throws IOException {
        ...
        f73a.b("Failed to find assets directory: %s", file);
        return null;
    }
    ...
    public final String e(String str) throws IOException {
        ...
        if (!file.exists()) {
            f73a.a("Pack not found with pack name: %s", str);
            return null;
        }
        File file2 = new File(file, String.valueOf(this.e.a()));
        if (!file2.exists()) {
            f73a.a("Pack not found with pack name: %s app version: %s", str, Integer.valueOf(this.e.a()));
            return null;
        }
        File[] listFiles = file2.listFiles();
        if (listFiles == null || (length = listFiles.length) == 0) {
            f73a.a("No pack version found for pack name: %s app version: %s", str, Integer.valueOf(this.e.a()));
            return null;
        } else if (length <= 1) {
            return listFiles[0].getCanonicalPath();
        } else {
            f73a.b("Multiple pack versions found for pack name: %s app version: %s", str, Integer.valueOf(this.e.a()));
            return null;
        }
    }
            ...
            if (next.listFiles() != null) {
                ...
                if (((long) this.e.a()) != J) {
                    try {
                        ...
                        f73a.b("Could not write staleness marker.", new Object[0]);
                    }
                }
