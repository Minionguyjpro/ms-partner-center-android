...
final class az extends AssetPackState {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof AssetPackState) {
            ...
            return this.f77a.equals(assetPackState.name()) && this.b == assetPackState.status() && this.c == assetPackState.errorCode() && this.d == assetPackState.bytesDownloaded() && this.e == assetPackState.totalBytesToDownload() && this.f == assetPackState.transferProgressPercentage() && this.g == assetPackState.a() && this.h.equals(assetPackState.b());
        }
    }
    ...
    public final int hashCode() {
        int hashCode = this.f77a.hashCode();
        int i = this.b;
        int i2 = this.c;
        long j = this.d;
        long j2 = this.e;
