...
public final class cb implements ce<ca> {
    ...
    public final /* bridge */ /* synthetic */ Object a() {
        int i = this.e;
        if (i == 0) {
            Object a2 = this.f104a.a();
            return new ca((au) a2, cc.c(this.b), (bo) this.c.a(), cc.c(this.d));
        } else if (i != 1) {
            Object a3 = this.c.a();
            Object a4 = this.b.a();
            return new cd((ca) a3, (au) a4, (bc) this.f104a.a(), (a) this.d.a());
        } else {
            return new bj((au) this.f104a.a(), cc.c(this.b), cc.c(this.c), (bo) this.d.a());
        }
    }
}
