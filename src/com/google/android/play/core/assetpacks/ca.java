...
final class ca {
    ...
    public final /* synthetic */ Map j(List list) {
        ...
        for (bx next : this.f.values()) {
            String str = next.c.f100a;
            if (list.contains(str)) {
                bx bxVar = (bx) hashMap.get(str);
                if ((bxVar == null ? -1 : bxVar.f101a) < next.f101a) {
    ...
    public final /* synthetic */ Boolean l(Bundle bundle) {
        ...
        if (map.containsKey(valueOf)) {
            bx s = s(i);
            int i2 = bundle2.getInt(i.e("status", s.c.f100a));
            if (ck.i(s.c.c, i2)) {
                ...
                if (ck.g(i2)) {
                    ...
                    for (by next : s.c.e) {
                        ArrayList parcelableArrayList = bundle2.getParcelableArrayList(i.f("chunk_intents", s.c.f100a, next.f102a));
                        if (parcelableArrayList != null) {
                            for (int i4 = 0; i4 < parcelableArrayList.size(); i4++) {
                                if (!(parcelableArrayList.get(i4) == null || ((Intent) parcelableArrayList.get(i4)).getData() == null)) {
                                    next.d.get(i4).f99a = true;
                                }
                            }
                        }
                    }
    ...
    public final /* synthetic */ void m(String str, int i, long j) {
        ...
        if (bxVar == null || ck.g(bxVar.c.c)) {
            f103a.b(String.format("Could not find pack %s while trying to complete it", new Object[]{str}), new Object[0]);
        }
        this.b.B(str, i, j);
        bxVar.c.c = 4;
    }
