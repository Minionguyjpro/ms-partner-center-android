...
final class cj implements t {
    ...
    private static final ag f109a = new ag("FakeAssetPackService");
    ...
    public final void b(List<String> list) {
        f109a.d("cancelDownload(%s)", list);
    }

    public final Task<List<String>> c(Map<String, Long> map) {
        f109a.d("syncPacks()", new Object[0]);
        return Tasks.a(new ArrayList());
    }

    public final void e(int i2, String str, String str2, int i3) {
        f109a.d("notifyChunkTransferred", new Object[0]);
    }

    public final void f(int i2, String str) {
        f109a.d("notifyModuleCompleted", new Object[0]);
        this.g.a().execute(new cg(this, i2, str));
    }

    public final void g(int i2) {
        f109a.d("notifySessionFailed", new Object[0]);
    }

    public final Task<ParcelFileDescriptor> h(int i2, String str, String str2, int i3) {
        f109a.d("getChunkFileDescriptor(session=%d, %s, %s, %d)", Integer.valueOf(i2), str, str2, Integer.valueOf(i3));
        ...
        try {
            ...
            f109a.e("getChunkFileDescriptor failed", e2);
            iVar.b(new LocalTestingException("Asset Slice file not found.", e2));
        } catch (LocalTestingException e3) {
            f109a.e("getChunkFileDescriptor failed", e3);
            iVar.b(e3);
        }
    }

    public final void j() {
        f109a.d("keepAlive", new Object[0]);
    }
    ...
    public final /* synthetic */ void m(int i2, String str) {
        try {
            ...
            f109a.e("notifyModuleCompleted failed", e2);
        }
    }
}
