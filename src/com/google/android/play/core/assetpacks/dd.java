...
final class dd {
    ...
    private static final ag f129a = new ag("VerifySliceTaskHandler");
    private final au b;
    ...
    private final void b(dc dcVar, File file) {
        try {
            File o = this.b.o(dcVar.k, dcVar.f128a, dcVar.b, dcVar.c);
            if (o.exists()) {
                try {
                    if (ck.a(db.a(file, o)).equals(dcVar.d)) {
                        f129a.d("Verification of slice %s of pack %s successful.", dcVar.c, dcVar.k);
                        return;
                    }
    ...
    public final void a(dc dcVar) {
        File h = this.b.h(dcVar.k, dcVar.f128a, dcVar.b, dcVar.c);
        if (h.exists()) {
            b(dcVar, h);
            File i = this.b.i(dcVar.k, dcVar.f128a, dcVar.b, dcVar.c);
            if (!i.exists()) {
                i.mkdirs();
            }
            if (!h.renameTo(i)) {
