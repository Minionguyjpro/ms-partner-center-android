...
final class ct {
    ...
    public final void a(cq cqVar) {
        Runnable runnable;
        Executor executor;
        File j = this.f119a.j(cqVar.k, cqVar.f116a, cqVar.b);
        File p = this.f119a.p(cqVar.k, cqVar.f116a, cqVar.b);
        if (!j.exists() || !p.exists()) {
            throw new bk(String.format("Cannot find pack files to move for pack %s.", new Object[]{cqVar.k}), cqVar.j);
        }
        File f2 = this.f119a.f(cqVar.k, cqVar.f116a, cqVar.b);
        f2.mkdirs();
        if (j.renameTo(f2)) {
            new File(this.f119a.f(cqVar.k, cqVar.f116a, cqVar.b), "merge.tmp").delete();
            File g = this.f119a.g(cqVar.k, cqVar.f116a, cqVar.b);
            g.mkdirs();
            if (p.renameTo(g)) {
                if (this.f.a()) {
                    executor = this.d.a();
                ...
                this.c.f(cqVar.k, cqVar.f116a, cqVar.b);
                this.e.a(cqVar.k);
    ...
    public final /* synthetic */ void b(cq cqVar) {
        this.f119a.r(cqVar.k, cqVar.f116a, cqVar.b);
    }
}
