...
final class an implements t {
    ...
    public static final ag f68a = new ag("AssetPackServiceImpl");
    ...
    an(Context context, bo boVar) {
        ...
        this.d = boVar;
        if (bp.a(context)) {
            this.e = new aq(p.c(context), f68a, "AssetPackService", b, u.b);
            this.f = new aq(p.c(context), f68a, "AssetPackService-keepAlive", b, u.f146a);
        }
        f68a.a("AssetPackService initiated.", new Object[0]);
    }
    ...
    static /* synthetic */ List v(an anVar, List list) {
        ...
        while (it.hasNext()) {
            ...
            if (next == null) {
                f68a.b("onGetSessionStates: Bundle contained no pack.", new Object[0]);
            }
            if (ck.f(next.status())) {
    ...
    public final void y(int i, String str, int i2) {
        if (this.e != null) {
            f68a.d("notifyModuleCompleted", new Object[0]);
            i iVar = new i();
    ...
    public final void e(int i, String str, String str2, int i2) {
        if (this.e != null) {
            f68a.d("notifyChunkTransferred", new Object[0]);
            i iVar = new i();
    ...
    public final void g(int i) {
        if (this.e != null) {
            f68a.d("notifySessionFailed", new Object[0]);
            i iVar = new i();
    ...
    public final Task<ParcelFileDescriptor> h(int i, String str, String str2, int i2) {
        ...
        f68a.d("getChunkFileDescriptor(%s, %s, %d, session=%d)", str, str2, Integer.valueOf(i2), Integer.valueOf(i));
        i iVar = new i();
    ...
    public final synchronized void j() {
        if (this.f == null) {
            f68a.e("Keep alive connection manager is not initialized.", new Object[0]);
            return;
        }
        f68a.d("keepAlive", new Object[0]);
        if (!this.g.compareAndSet(false, true)) {
            f68a.d("Service is already kept alive.", new Object[0]);
            return;
        }
        i iVar = new i();
