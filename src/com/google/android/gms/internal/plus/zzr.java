...
public final class zzr extends FastSafeParcelableJsonResponse implements Person {
    ...
    public static final class zzb extends FastSafeParcelableJsonResponse implements Person.Cover {
        ...
        public static final class C0014zzb extends FastSafeParcelableJsonResponse implements Person.Cover.CoverPhoto {
            public static final Parcelable.Creator<C0014zzb> CREATOR = new zzw();
            private static final HashMap<String, FastJsonResponse.Field<?, ?>> zzao;
            private final Set<Integer> zzap;
            private int zzbu;
            private int zzbv;
            ...
            C0014zzb(Set<Integer> set, int i, int i2, String str, int i3) {
                this.zzap = set;
                this.zzw = i;
                this.zzbu = i2;
                this.zzk = str;
            ...
            public final boolean equals(Object obj) {
                if (!(obj instanceof C0014zzb)) {
                    return false;
                }
                if (this == obj) {
                    return true;
                }
                C0014zzb zzb = (C0014zzb) obj;
                for (FastJsonResponse.Field next : zzao.values()) {
                    if (isFieldSet(next)) {
        ...
        static {
            ...
            zzao.put("coverPhoto", FastJsonResponse.Field.forConcreteType("coverPhoto", 3, C0014zzb.class));
        ...
        zzb(Set<Integer> set, int i, zza zza2, C0014zzb zzb, int i2) {
            this.zzap = set;
            this.zzw = i;
            this.zzbp = zza2;
            this.zzbq = zzb;
