...
public abstract class a {
    ...
    private b f41a = new b((WebView) null);
    ...
    public void a(String str, double d2) {
        if (d2 > this.e) {
            this.d = C0008a.AD_STATE_VISIBLE;
            d.a().c(c(), str);
        }
    }
    ...
    public void b(String str, double d2) {
        if (d2 > this.e && this.d != C0008a.AD_STATE_HIDDEN) {
            this.d = C0008a.AD_STATE_HIDDEN;
            d.a().c(c(), str);
        }
    }

    public WebView c() {
        return (WebView) this.f41a.get();
    }
