...
public final class a {
    ...
    public void a(float f) {
        ...
        this.f19a.f().a("volumeChange", jSONObject);
    }
    ...
    public void a(float f, float f2) {
        ...
        com.b.a.a.a.e.b.a(jSONObject, "deviceVolume", Float.valueOf(com.b.a.a.a.c.e.a().d()));
        this.f19a.f().a("start", jSONObject);
    }

    public void b() {
        e.c(this.f19a);
        this.f19a.f().a("midpoint");
    }

    public void c() {
        e.c(this.f19a);
        this.f19a.f().a("thirdQuartile");
    }

    public void d() {
        e.c(this.f19a);
        this.f19a.f().a("complete");
    }
    ...
    public void f() {
        e.c(this.f19a);
        this.f19a.f().a("bufferStart");
    }

    public void g() {
        e.c(this.f19a);
        this.f19a.f().a("bufferFinish");
    }

    public void h() {
        e.c(this.f19a);
        this.f19a.f().a("skipped");
    }
}
