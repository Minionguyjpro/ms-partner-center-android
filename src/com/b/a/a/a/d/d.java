...
public class d implements a {
    ...
    private final int[] f38a = new int[2];

    private void a(ViewGroup viewGroup, JSONObject jSONObject, a.C0007a aVar) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            aVar.a(viewGroup.getChildAt(i), this, jSONObject);
        }
    }

    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.C0007a aVar) {
    ...
    public JSONObject a(View view) {
        ...
        view.getLocationOnScreen(this.f38a);
        int[] iArr = this.f38a;
